...
<tr class="labelmedium line">
    <TD align="center"><a href="javascript:showDomainClass('#URL.ID1#', '')"><font color="0080C0">[Add]</font></a></TD> 
		...
		<table>
			<tr>
				...
				<td style="padding-left:6px;padding-top:3px">
					<cf_img icon="edit" navigation="Yes" onclick="showDomainClass('#URL.ID1#', '#Code#')">
				</td>
