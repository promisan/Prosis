...
<cfajaximport tags="cfdiv,cfform,cfwindow,cfinput-autosuggest">
<cf_calendarscript>
...
function showme(box,code,mis) {
	...
	if (se.className == "hide") {		
		...
		ColdFusion.navigate('ActionServiceItem.cfm?mission='+mis+'&alias=#alias#&code='+code,'content_'+box)
	} else {		
		se.className  = "hide"			
	}
}
...
function saveitem(code) {
   ColdFusion.navigate('ActionServiceItemSubmit.cfm?code='+code,'process','','','POST','form'+code)
}
