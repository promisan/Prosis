...
<cfform action="RecordSubmit.cfm?id=#url.id#&alias=AppsWorkOrder" method="POST" name="dialog">
...
<table width="92%" align="center" class="formpadding formspacing">
    ...
    <TR>
    <TD width="25%" class="labelmedium2"><cf_tl id="Code">:</TD>
    <TD>
	...
	<tr>
		<td class="labelmedium2"><cf_tl id="Entry Mode">:</td>
	...
	<TR>
    <TD class="labelmedium2"><cf_tl id="Notification action">:</TD>
    <TD>
	   <table><tr class="labelmedium2">
	   <td>
	      <cf_securediv bind="url:getActionNotification.cfm?action=#get.ActionNotification#&mission={mission}" id="notification">	     
	   </td>
	   
	   <td style="padding-left:3px">
	    <cfinput type="Text" name="ActionNotificationDays" value="#get.ActionNotificationDays#" style="text-align:center" message="Please enter a numeric listing order" 
		   required="Yes" size="2" validate="integer" maxlength="3" class="regularxxl">
	   </td>
	   
	   <td style="padding-left:3px">days</td>		 
	   </tr></table>
	...
	<tr>
		<td class="labelmedium2"><cf_tl id="Request Mode">:</td>
		<td class="labelmedium">
		<table>
	...
	<tr>
		<td class="labelmedium2"><cf_tl id="Action Planning">:</td>
		<td class="labelmedium">
		<table><tr class="labelmedium2"><td>
		<select name="ActionFulfillment" class="regularxxl" onchange="showmode(this.value)">
		...
		<td style="padding-left:6px"><input class="radiol" type="checkbox" name="Protocol" <cfif getprotocol.recordcount eq "1">checked</cfif> value="#itm#"></td><td style="padding-left:3px">#itm#</td>
		</cfloop>		
		</tr>
	...
	<tr>
		<td class="labelmedium2"><cf_tl id="Date validation">:</td>
