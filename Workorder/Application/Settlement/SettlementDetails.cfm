...
<cfswitch expression="#url.mode#">
	...
	<cfcase value="Check">
		...
		<tr>
			...
			<tr>
				<td width="3%"></td>			
				<td><input type="text" id="reference_number" name="reference_number" size="8" maxlength="8" class="regularxl" onfocus="javascript:setFocus(this,'no')"></td>
				<td><input type="text" id="approval_number"  name="approval_number" size="8" maxlength="8" class="regularxl" onfocus="javascript:setFocus(this,'no')"></td>							
			</tr>		
			</table>
		</tr>				
		<tr><td height="2" colspan="9" align="center"></td></tr>
