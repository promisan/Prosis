	...
	<cfoutput>
		...
		<script>	
			...
			ColdFusion.navigate('#SESSION.root#/WorkOrder/Application/Assembly/EarmarkStock/setWarehouseTo.cfm?itemno=#url.itemno#&mission=#url.mission#&warehouse=#warehouse.warehouse#','boxtransferto')								
		</script>
