			   ...
			   <table cellspacing="0" cellpadding="0" width="100%" height="100%" class="formpadding">
					...
					<tr>
						...
						<cfselect name="workorderidselect"
					          ...
					          value="workorderid"
					          display="reference"
							  onchange="javascript:ColdFusion.navigate('#SESSION.root#/Workorder/Application/Assembly/EarmarkStock/getWorkorderItem.cfm?mission=#workorder.mission#&warehouse=#url.warehouse#&workorderid='+this.value,'itemselect')"
					          visible="Yes"
