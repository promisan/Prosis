...
<cfoutput>
	...
	<script language="JavaScript">
	     if (document.getElementById('selectfields')) {
		  ColdFusion.navigate('#session.root#/WorkOrder/Application/Assembly/Items/HalfProduct/HalfProductSelectItem.cfm?workorderid=#url.workorderid#&workorderline=#url.workorderline#&itemno=#vitemno#&uom=#uom#&itemmaster=#GetItemDef.ItemMaster#&mission=#workorder.mission#','selectfields')
		 }
	</script>	
