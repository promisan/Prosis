...
<cf_tl id="Edit half product" var="1">
...
<cfoutput>
	...
	<cfform name="frmFinalProduct" method="post" 
		  ...
		  action="HalfProductEditSubmit.cfm?workorderitemid=#url.workOrderItemId#">
		...
		<table width="93%" cellspacing="0" cellpadding="0" align="center" class="formpadding">
			...
			<tr>
				...
				<td style="padding:2px;" colspan="2">
					...
					<cfset link = "#session.root#/WorkOrder/Application/Assembly/Items/HalfProduct/getItem.cfm?itemNo=#get.itemNo#&workorderid=#url.workOrderId#&workorderline=#url.workorderline#&uom=#get.uom#">
			...
			<cfquery name="CommodityList" 
				...
				<TR>
			    <TD class="labelmedium" style="padding-left:10px"><cf_space spaces="43"><cf_tl id="Commodity">:</TD>
			...
			<tr>
				...
				<select name="Warehouse" class="regularxl">
					<cfloop query="qWarehouse">
					    <option value="#warehouse#" <cfif get.Warehouse eq warehouse>selected</cfif>>#WarehouseName#</option>
					</cfloop>
				</select>
			...
			<tr>
				...
				<td style="padding:2px;">
					...
					<cfinput type="text" class="regularxl" name="transactionlot" id="transactionlot" value="#Get.TransactionLot#" required="false" style="width:80px; text-align:right; padding-right:2px;">
				</td>
			</tr>		
			...
			<tr>
				...
				<td style="padding:2px;height:25;width:140">
					<cf_tl id="Please, enter a valid numeric price greater than 0." var="1">
					<cfinput type="text" class="regularxl" name="price" id="price" value="#numberformat(Get.SalePrice,'_.__')#" required="true" message="#lt_text#" validate="float" range="0.00000000001," style="width:80px; text-align:right; padding-right:2px;">
				</td>				
			</tr>
			...
			<tr class="hide">
				...
				<td style="padding:2px;" id="extended">
					...
					<tr>
					<td bgcolor="f4f4f4" style="height:25;width:140">
			...
			<tr>
				<td class="labelmedium" style="padding-left:10px;">
					<cf_tl id="Stock Value">:
				</td>
				<td style="padding:2px;" id="payable">
				  <table cellspacing="0" cellpadding="0">
					<tr>
					<td bgcolor="f4f4f4" style="height:25;border:0px solid silver;width:140">
