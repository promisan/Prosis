...
<table width="100%" class="formspacing">
	...
	<tr>
	   ...
	   <td align="right" class="labelit line"><cf_tl id="Memo"></td>	   
	...
	<cfoutput query="items">
		...
		<input type="text" name="Memo" id="Memo_#workorderitemid#" value="" class="regularxl enterastab" 
		   maxlength="200" style="width:100%; padding-right:2px;"  
