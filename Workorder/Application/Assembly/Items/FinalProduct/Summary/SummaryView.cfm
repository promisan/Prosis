...
<tr><td height="20" style="padding-top:4px" class="labellarge"><cf_tl id="Workorder Quotation recapitulation in"> #application.BaseCurrency#</td></tr>
...
<tr><td height="100%">
	...
	<tr><td width="50%" valign="top" style="padding:15px">
		<cfinclude template="QuotationView.cfm">
		</td>
