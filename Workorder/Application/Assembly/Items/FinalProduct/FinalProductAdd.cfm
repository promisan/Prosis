...
<cf_tl id="Record requested finished product" var="1">
...
<cf_layout attributeCollection="#attrib#">
	...
	<cf_layoutarea 
		...
		<cf_ViewTopMenu label="#lblFinal#" background="blue">
				...
				<td height="100%" style="padding:2px;">
					...
					<table width="100%" height="100%">
					    ...
					    <tr><td style="padding-top:5px">
							...
							<cfoutput>
							<input type="text" 
								onkeyup="_cf_loadingtexthtml='';ptoken.navigate('FinalProductItemSelect.cfm?workorderid=#url.workorderid#&workorderline=#url.workorderline#&mission=#workorder.mission#&find='+this.value,'items')"
						...
						<tr>
							...
							<td style="padding-right:0px;height:100%">
								...
								<cf_divscroll id="items">	
									...
									<cfinclude template="FinalProductItemSelect.cfm">									
	...
	<cf_layoutarea position="center" name="box" overflow="scroll">
		...
		<table width="96%" height="100%" align="center">
			...
			<tr><td style="height:1px" colspan="2" id="selectfields"></td></tr>						
			
			<!--- shows the valid combinations --->
			<tr><td style="height:100%" valign="top" colspan="2" id="finalproduct"></td></tr>	
			
			<!--- shows the final project items selected --->
			<tr><td style="height:200px" colspan="2" id="selecteditems"><cfinclude template="FinalProductSelected.cfm"></td></tr>			
