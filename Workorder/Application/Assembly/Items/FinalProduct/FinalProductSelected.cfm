...
<table width="100%" style="background-color:f1f1f1">
	...
	<cfif selecteditems.recordcount gte "0">
	    ...
	    <cf_divscroll height="250">
	
		<table width="98%" class="navigation_table">	
		
		<cfif selecteditems.recordcount gte "1">
						
			<tr><td align="center" colspan="13" style="height:40px">
				<cfoutput>
				    <cf_tl id="Apply Finished Product" var="label">
					<input type="button" name="Submit" value="#label#" style="border:1px solid silver;width:220;height:28px" class="button10g" 
		...
		<cfoutput query="SelectedItems">
			<tr class="labelmedium2 navigation_row line fixlengthlist">
			  ...
			  <td>#Currency#</td>
			  <td align="right" style="padding-right:5px">#numberformat(Price,",.__")#</td>  
			</tr>
		</cfoutput>
