...
<!--- template to select the warehouse and location to move unearmarked stock to be be earmarked --->
...
<table width="91%" cellspacing="5" cellpadding="2" align="center" class="formpadding formspacing">
	...
	<tr><td colspan="2" valign="bottom" align="center" style="height:60">
		  ...
		  <input type="button" 
			  ...
			  onclick="Prosis.busy('yes');ptoken.navigate('#session.root#/workorder/application/Assembly/Items/Earmark/BOMUnEarmarkSubmit.cfm?mode=#url.mode#&action=8&workorderid=#url.workorderid#&workorderline=#workorderline#&warehouse=#url.warehouse#&category=#url.category#&pointersale=#url.pointersale#&destinationwarehouse='+document.getElementById('destinationwarehouse').value+'&destinationlocation='+document.getElementById('destinationlocation').value,'process','','','POST','fGeneration');ColdFusion.Window.destroy('dialogdestination',true);"
			  value="#tReserve#"
			  class="button10g">
