...
<script language="JavaScript">
	...
	function linebillingdetail(wid,lid,bid) {       
	   ...
	   ColdFusion.Window.create('myprovision', 'Provisioning', '',{x:100,y:100,height:document.body.clientHeight-80,width:1150,modal:true,center:true,resizable:true})    
	...
	function addsupply(mis,wid,lid) {  	   
	   ptoken.open("#SESSION.root#/Warehouse/Application/Stock/Transaction/TransactionInit.cfm?mode=workorder&mission="+mis+"&workorderid="+wid+"&workorderline="+lid,"workorder","left=20, top=20, width=960,height=800,status=yes, toolbar=no, scrollbars=yes, resizable=yes")	 	
	}
