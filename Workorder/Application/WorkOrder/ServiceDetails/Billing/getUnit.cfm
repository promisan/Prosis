...
<cfelse>
	...
	<script language="JavaScript">
		...
		document.getElementById('#UnitClass#_stdprice').innerHTML              = "#numberformat(get.standardcost,'__,__.__')#"		
		document.getElementById('#UnitClass#_standardcost_0').value            = "#numberformat(get.standardcost,'__,__.__')#"			
		document.getElementById('#UnitClass#_specification_content').innerHTML = "#unit.UnitSpecification#"			
		document.getElementById('total_#UnitClass#_0').innerHTML               = "#numberformat('#url.quantity*get.standardcost#','__,__.__')#"
