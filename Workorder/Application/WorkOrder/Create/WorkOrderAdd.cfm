...
<cfif url.context eq "Portal">
   	<cf_screentop jquery="yes" height="100%" label="#ucase(url.mission)# #headerlabel#" html="yes" scroll="no" layout="webapp" banner="gray" bannerforce="Yes">
<cfelseif url.context eq "workflow">    
   	<cf_screentop jquery="yes" height="100%" label="#ucase(url.mission)# #headerlabel#" html="no" scroll="no" layout="webapp" banner="gray" bannerforce="Yes">
<cfelseif url.context eq "ajax">
    <cf_screentop jquery="yes" height="100%" label="#ucase(url.mission)# #headerlabel#" html="no" close="parent.ColdFusion.Window.destroy('myorder',true)" layout="webapp" scroll="no" banner="gray"> 
<cfelseif url.context eq "embed">
    <cf_screentop jquery="yes" height="100%" label="#ucase(url.mission)# #headerlabel#" html="no" close="parent.ColdFusion.Window.destroy('myorder',true)" layout="webapp" scroll="no" banner="gray"> 	
<cfelse>
    <cf_screentop jquery="yes" height="100%" label="#ucase(url.mission)# #headerlabel#" layout="webapp" scroll="no" banner="gray">
</cfif>	

<table width="100%" height="100%">

<tr><td width="100%" style="padding-left:30px">
