...
<table width="97%" cellspacing="0" cellpadding="0" class="formpadding" align="center">
 ...
 <tr>
	...
	<td width="90" class="labelmedium"><cf_tl id="Issued InvoiceNo">:</td>
	...
	<td width="60" class="labelmedium" style="min-width:140px"><cf_tl id="Date">:</td>
	<td class="labelmedium" style="padding-left:3px;min-width:120px">
	...
	<td width="60" class="labelmedium"><cf_tl id="Owner">:</td>
