...
<table width="98%" class="navigation_table" cellspacing="1" align="center" style="padding-right:4px">
	...
	<tr><td colspan="7" style="height:40px" align="center">
		<input type="button" class="button10g" style="width:250px;height:28px" value="Send TTS" onClick="javascript:send_tts('#resultList.recordcount#')">
	</td></tr>
	...
	<tr class="line labelmedium">
		...
		<td width="4%" align="center">
			...
			<input type="checkbox" class="radiol" id="toggle" name="toggle" onclick = "mark_tts(this.checked,'#resultlist.recordcount#')">
			...
			<tr class="labelmedium" id="r#currentrow#" bgcolor="<cfif notifications eq 0>ffffaf</cfif>">
				<td align="center">								
				    <cfif PhoneNumber neq "">
						<input type="checkbox" class="radiol"  id="ctts" name="ctts" value="#WorkOrderId#|#WorkOrderLine#|#PhoneNumber#">
					<cfelse>
					n/a	
					</cfif>
				</td>
