...
<script>
	...
	function send_smtp(total) {
		...
		ColdFusion.Window.create('bb_tts', 'PROSIS eMail Service','Notification/SMTP/SMTPProcess.cfm',{height:320,width:510,modal:false,closable:true,draggable:true,resizable:false,center:true,initshow:true })				
		}
	}	
	...
	function send_smtp_go() {
		...
		ColdFusion.navigate('Notification/SMTP/SMTPSubmit.cfm?dts='+se+'&txt='+e.value,'processing_smtp','','','post','mapform');
	}
