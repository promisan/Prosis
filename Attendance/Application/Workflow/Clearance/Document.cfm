...
<table width="98%" height="100%" class="formpadding">
	 ...
	 <tr style="height:10px" class="labelmedium">
		  <td rowspan="2" style="padding-left:3px;border-bottom:1px solid silver;min-width:300">
		  <table align="center">
		  <tr class="labelmedium"><td align="center" style="font-size:21px;font-weight:300"><cf_tl id="Clearance"></td></tr>
		  ...
		  <td style="width:100%;min-width:200px;padding-left:3px;border-bottom:1px solid silver" align="center" rowspan="2"><cf_tl id="Staff"></td>	
		  <td style="min-width:80;padding-left:3px;border-bottom:1px solid silver" align="center" rowspan="2"><cf_tl id="Grade"></td>
		  <td style="background-color:##b0b0b050;padding-left:3px;border-bottom:1px solid silver" align="center" colspan="3"><cf_tl id="Contract"></td>
		  <td colspan="#modality.recordcount#" align="center" style="background-color:##43CD9980;padding-left:3px;border-bottom:1px solid silver"><cf_tl id="Overtime">Payable</td>
		  <td colspan="#modality.recordcount#" align="center" style="background-color:##FFFF8050;padding-left:3px;border-bottom:1px solid silver"><cf_tl id="Overtime">CTO</td>
		  <td align="center" style="background-color:##e5aec480;padding-left:3px;border-bottom:1px solid silver"><cf_tl id="Night"></td>
		  <td></td>
	 </tr>
	  
	 <tr style="height:10px" class="line"> 
		  <td align="center" style="background-color:##d0d0d050;padding-left:3px;border:1px solid silver;min-width:64"><cf_tl id="Worked"></td>
		  <td align="center" style="background-color:##D0FDC450;padding-left:3px;border:1px solid silver;min-width:64"><cf_tl id="Leave"></td>
		  <td align="center" style="background-color:##e0e0e050;padding-left:3px;border:1px solid silver;min-width:64"><cf_tl id="Days"></td>
		  <cfloop query="Modality">
		  <td align="center" style="background-color:##43CD9950;padding-left:3px;border:1px solid silver;min-width:64"><cf_tl id="#Description#"></td>
		  </cfloop>
		  <cfloop query="Modality">
		  <td align="center" style="background-color:##FFFF80;padding-left:3px;border:1px solid silver;min-width:64"><cf_tl id="#Description#"></td>
		  </cfloop>
		  <td align="center" style="background-color:##e5aec480;padding-left:3px;border:1px solid silver;min-width:64"><cf_tl id="Diff"></td>	 
...
<td align="center" colspan="15" style="height:100%;width:100%">
	...
	<form name="clearanceform" style="height:100%">  
		 ...
		 <cf_divscroll overflowy="Scroll">
			...
			<!--- ensures the same with of the table --->
				  
			 <tr style="height:1px"> 
			  <td style="min-width:300px"></td>
			  <td style="width:100%;min-width:300px"></td>
			  <td style="min-width:84"></td>
			  <td style="min-width:64"></td>
			  <td style="min-width:64"></td>
			  <td style="min-width:64"></td>
			  <cfloop query="Modality">
			  <td style="min-width:64"></td>
							  ...
							  <table>
								  ...
								  <td>	
									  ...
									  <cfloop index="itm" list="0,1,9">								  
									     <td style="padding:2px;background-color:<cfif itm eq '0'>##C0C0C080<cfelseif itm eq '1'>##00FF0080<cfelse>##FF000080</cfif>">									
								    ...
								    <td style="padding-left:4px" id="review#personno#">
									  ...
									  <table style="width:100%">
											...
											<td style="padding-left:2px">#dateformat(get.created,"MM/DD")# #timeformat(get.created,"HH:MM")#: #get.OfficerLastName#</td>
