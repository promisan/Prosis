...
function recordedit(id) {
    ptoken.open("RecordEdit.cfm?idmenu=#url.idmenu#&ID=" + id, "Edit", "left=80, top=80, width= 550, height= 450, toolbar=no, status=no, scrollbars=no, resizable=no");
}
...
<cfoutput query="SearchResult" group="Mission">		
		...
		<tr>
		    <td style="font-size:20px;height:30px" class="labellarge" colspan="6">#Mission#</td>	
		</tr>
		...
		<cfoutput>					
			...
			<tr class="line navigation_row labelmedium">
				<td></td>				
				<td><a href="javascript:recordedit('#code#')" class="navigation_action">#Code#</a></td>
