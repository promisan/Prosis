...
<cf_divscroll>
	...
	<table width="95%" align="center" class="formpadding formspacing">
		...
		<TR class="labelmedium clsCreditCalculation" style="<cfoutput>background-color:#vCreditDetailBGColor#; #vDisplayCreditCalculation#</cfoutput>">
	    <TD>Credit:</TD>
	    <TD>
		...
		<cfif getLeave.LeaveAccrual eq "1">
			...
			<TR class="labelmedium clsCreditCalculation" style="<cfoutput>background-color:#vCreditDetailBGColor#; #vDisplayCreditCalculation#</cfoutput>">
		    <TD valign="top" style="padding-top:5px;">Credit Calculation:</TD>
		    <TD valign="top" style="padding-top:3px;">
			    <table width="100%">
					<tr class="labelmedium"><td><INPUT type="radio" class="radiol" name="Calculation" id="Calculation" value="Day" <cfif Get.Calculation eq "Day">checked</cfif>></td>
					    <td style="padding-left:5px">Pro-rated per day (0.5 days)</td>
					</tr>
					<tr class="labelmedium"><td><INPUT type="radio" class="radiol" name="Calculation" id="Calculation" value="WorkDay" <cfif Get.Calculation eq "WorkDay">checked</cfif>></td>
					    <td style="padding-left:5px">Pro-rated per Work day (0.5 days)</td>
					</tr>
					<tr class="labelmedium"><td><INPUT type="radio" class="radiol" name="Calculation" id="Calculation" value="Formula" <cfif Get.Calculation eq "Formula">checked</cfif>></td>
		...
		<TR class="labelmedium clsCreditEntitlement" style="<cfoutput>#vDisplayCreditEntitlement#</cfoutput>">
	    <TD valign="top" style="padding-top:5px;">Entitlement:</TD>
	    <TD valign="top" style="padding-top:3px;">
	  	   <cfdiv id="divCreditEntitlement" 
	    ...
	    <TD>
		  <table cellspacing="0" cellpadding="0"><tr><td>
	  	   <cfinput class="regularxl" type="Text" name="CarryOverMaximum" id="CarryOverMaximum" value="#Get.CarryOverMaximum#" message="Please enter a maximum" style="width:40;text-align: center;" validate="numeric" required="Yes" size="8" maxlength="6">
		   </td>
		   <td style="padding-left:10px" class="labelmedium">
	       apply per:
		   </td>
		   <td style="padding-left:10px">
		   <cfinput class="regularxl" type="Text"  name="CarryOverOnMonth" id="CarryOverOnMonth" value="#Get.CarryOverOnMonth#" range="0,12" message="Please enter a month No" validate="integer" required="Yes" 
		   size="4" maxlength="4" style="width:50;text-align: center;">
		   </td>
		...
		<TR class="labelmedium">
	    <TD>Maximum in Credit Period:</TD>
	    <TD>
	  	   <cfinput type="Text" class="regularxl" name="AccumulationPeriod" id="AccumulationPeriod" value="#Get.AccumulationPeriod#" message="Please enter a number of months" style="width:50;text-align: center;" validate="integer" required="Yes" maxlength="2">&nbsp;&nbsp;Months
	    </TD>
		</TR>
	    ...
	    <TD>
	  	   <cfinput type="Text" class="regularxl" name="MaximumBalance" id="MaximumBalance" value="#Get.MaximumBalance#" message="Please enter a maximum" style="width:50;text-align: center;" validate="integer" required="Yes" size="4" maxlength="4">
	    </TD>
		</TR>
			
		<TR class="clsCreditCalculation <cfif get.CreditPeriod eq 'Contract'>hide</cfif> labelmedium">
	    <TD>Overdraw in months:</TD>
	    <TD>
	  	   <cfinput type="Text" class="regularxl" name="AdvanceInCredit" id="AdvanceInCredit" value="#Get.AdvanceInCredit#" message="Please enter a number" style="width:50;text-align: center;" validate="integer" required="Yes" size="3" maxlength="2">
	    </TD>
		</TR>
