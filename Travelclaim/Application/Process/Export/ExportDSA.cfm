...
<cfsilent>
	...
	<proDes>Changes to Meals and Accommodation Indicator</proDes>
	<proCom>Added a date condition to check if meals and accommodation was provided for that spefic date (Added Line 115: and meal.calendardate=stExportFileLine.linedate) </proCom>
</cfsilent>			 
...
AND       ClaimId IN
              (SELECT DISTINCT Meal.ClaimId
			   ...
			   and meal.calendardate=stExportFileLine.linedate)
</cfquery>											
