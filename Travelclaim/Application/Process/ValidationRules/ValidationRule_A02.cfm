...
<cfquery name ="ClaimValidationCheck" datasource="appsTravelClaim" username="#SESSION.login#" password="#SESSION.dbpw#">
						SELECT 
								ClaimId, 
								ValidationCode,
								CalculationId
...
<cfif AccountingQuery.recordcount gt 1 >
<cfif fileExists("#SESSION.rootPath#/TravelClaim/Application/Process/ValidationRules/SetAcctPeriod.cfm")>
