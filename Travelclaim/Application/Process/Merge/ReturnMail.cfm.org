...
<cfif parameter.returnreminder eq "1">
	...
	<cfloop query="EMailList">
		...
		<cfif address neq "" and (check.recordcount eq "1" or GetAddressDW.Emailaddress neq "")>		
				...
				<cfmail 
			        to       = "#address#"
					from     = "Travel Claim Portal <tcp_do_not_reply@un.org>"
			   ...
			   password="#CLIENT.dbpw#">
				   INSERT INTO ClaimRequestMail
				         (ClaimRequestId, 
						  ...
						  eMailAddress, 
						  OfficerUserId)
				   VALUES ('#ClaimRequestId#','#FullNameIns#','#Address#','#client.acc#')			     
			   </cfquery>			 
					   ...
					   password="#CLIENT.dbpw#">		
						   ...
						   INSERT INTO ClaimRequestMail
						         (ClaimRequestId, 
								  ...
								  eMailAddress, 
								  OfficerUserId)
						   VALUES ('#ClaimRequestId#','0','#User.FirstName# #User.LastName#','#Address#','#client.acc#')			     
					   </cfquery>	
