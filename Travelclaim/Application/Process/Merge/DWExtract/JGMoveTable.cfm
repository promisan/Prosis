...
<CF_DropTable dbName="appsTravelClaim"  full="1" tblName="IMP_CLAIMAPPROVAL">
<CF_DropTable dbName="appsTravelClaim"  full="1" tblName="IMP_CLAIMRECOVERYSCHED">
<CF_DropTable dbName="appsTravelClaim"  full="1" tblName="IMP_CLAIMCREATION">
...
<CF_CopyTable from="#srvdw#.#dbdw#" DS_TO="appsTravelClaim"  tblName="IMP_CLAIMAPPROVAL">
<CF_CopyTable from="#srvdw#.#dbdw#" DS_TO="appsTravelClaim"  tblName="IMP_CLAIMRECOVERYSCHED">
<CF_CopyTable from="#srvdw#.#dbdw#" DS_TO="appsTravelClaim"  tblName="IMP_CLAIMCREATION">

<!--- HS 08 Dec 2009 : Added the below tables needed for reporting purpose ---->

<CF_CopyTable from="#srvdw#.#dbdw#" DS_TO="appsTravelClaim"  tblName="IMP_DSARate_h">
<CF_CopyTable from="#srvdw#.#dbdw#" DS_TO="appsTravelClaim"  tblName="IMP_DSARateUpload">
<CF_CopyTable from="#srvdw#.#dbdw#" DS_TO="appsTravelClaim"  tblName="IMP_InterOfficeAgencyAuth">