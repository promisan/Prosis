...
<!----------------------------Modification Details------------------------------------------
 		Date: 04/11/2008
		By:		Huda Seid	
		Change: Added the showclaimother function to the padlocked(object_locked.gif) travel claims so EO/Accounts 
				can still view the claim details even if it's locked for further processing.
       Added line:	 onClick="showclaimother('#ClaimId#','#ClaimRequestId#')">
-------------------------------------------------------------------------------------------->
<cftry>
					...
					<cfif currrow gte first and currrow lte last>									
						...
						<TR #stylescroll# bgcolor="#IIf(CurrentRow Mod 2, DE('FFFFFF'), DE('ffffff'))#">
						   ...
						   <TD width="5%" height="15" align="center">
							 ...
							 <cfif PointerStatus eq "0" and ReferenceNo eq "">
