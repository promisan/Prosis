...
<CF_DropTable dbName="AppsQuery" tblName="clm#CLIENT.acc#subset#FileNo#Pending">	
<CF_DropTable dbName="AppsQuery" tblName="clm#CLIENT.acc#subset#FileNo#Others">	
	...
	<cfloop index="base" list="#qlist#">
		...
		<cfquery name="Subset" 
			...
			INTO     userQuery.dbo.clm#client.acc#subset#FileNo##base#
		...
		<cfsavecontent variable="pending">
			SELECT   DISTINCT TOP 401 R.*, 
			    ...
			    FROM     ClaimRequest R, 
				         Ref_ClaimPurpose P, 
						 Ref_Status S, 
						 userQuery.dbo.clm#client.acc#subset#FileNo#pending T
		...
		<cfsavecontent variable="others">
			...
			SELECT  DISTINCT TOP 401 R.*, 
			    ...
			    FROM    ClaimRequest R, 
						...
						Ref_Status S,
						Ref_Status S1,
						userQuery.dbo.clm#client.acc#Subset#FileNo#others T
			...
			<cfoutput>
				...
				<cfset currrow = currrow + 1>
					...
					<cfif currrow gte first and currrow lte last>									
						...
						<img height="11" width="11" align="absmiddle" onclick="javascript:reload('Employee','#out#')" style="cursor:hand" src="#client.root#/images/locate.gif" alt="" border="0">
						</cftooltip>
						...
						<TR #stylescroll# bgcolor="#IIf(CurrentRow Mod 2, DE('FFFFFF'), DE('ffffff'))#">
						   ...
						   <TD width="5%" height="15" align="center">
							 ...
							 <cfset i = "#CLIENT.Root#/Images/bullet.png">
							 <cfset t = "View claim">
														 
							 <cfif PointerStatus eq "0">
						
							 <img src="#CLIENT.Root#/Images/object_locked.gif"
						     alt="#t#"
