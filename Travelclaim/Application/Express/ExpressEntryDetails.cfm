...
<cfsilent>
	...
	<proDes> Allow attachments for Express added help text too for the same</proDes>
	<proCom></proCom>
	<proCM></proCM>
	<proInfo>
	<table width="100%" cellspacing="0" cellpadding="0">
	<tr><td>
	Express Entry details screen
	</td></tr>
	</table>
	</proInfo>
...
<table border="0" cellspacing="2" cellpadding="2">
	...
	<tr>
		...
		<!--- JG Added the place where Attachements are available for Express too. Used the 
		      Existing Cfm file to make that call and also made sure that the variable Url.mode
			  is set as param to avoid failures  --->
		<tr><td height="4" colspan="3">
		
			<table cellspacing="0" cellpadding="0">
			<tr>
			<td width="30"><img src="#bullet#" alt="" border="0"></td>
			<td height="1" colspan="3"><b>&nbsp;Attachements</b>&nbsp;</td> 
			<td>
			  <cf_helpfile code       = "TravelClaim" 
						    id          = "Remarks" 
							display     = "Icon"	
			   ...
			   <cfinclude template="../EventEntry/ClaimEventAdditionalAttachment.cfm"> 		
			   </td>
