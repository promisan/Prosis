...
<link href="<cfoutput>#client.root#</cfoutput>/<cfoutput>#client.style#</cfoutput>" rel="stylesheet" type="text/css">
...
<tr><td valign="top">
	...
	<td colspan="#cols#" valign="top">
		...
		<tr>
		<td width="25"><cfoutput><img src="#client.root#/images/join.gif" alt="" border="0"></cfoutput></td>
		...
		<tr>
	      <td colspan="#cols#" height="35" width="96%">
			  ...
			  <table width="100%" height="16" bgcolor="ffffff" border="1" cellspacing="1" cellpadding="1" bordercolor="E1E1E1" align="center" rules="rows">
			    ...
			    <td>
			      <img src="#client.root#/images/finger.gif" 
				     alt="" 
					 border="0" 
					 align="absmiddle"> Use the check boxes to indicate Accommodation and/or Meals provided, and any annual or other leave days taken
				...
				<cfloop index="day" from="0" to="#diff-1#"> 
					...
					<cfset d = DateAdd("d", "#day#", "#Period.Start#")> 
						...
						<cftry>
							...
							<cfquery name="Insert" 
							datasource="appsTravelClaim">
								INSERT INTO userQuery.dbo.clm#client.acc#Trip
