...
<cfoutput>
<cfsavecontent variable="vwReceivables">
...
<cfsavecontent variable="myquery">
	  ...
	  FROM (
	      ...
	      SELECT      TOP 100 PERCENT  H.TransactionCategory, 
	                    ...
	                    ROUND(H.Amount - SUM ((L.AmountCredit - L.AmountDebit) * L.ExchangeRate ) OVER (PARTITION BY H.Journal, H.JournalSerialNo ORDER BY L.TransactionDate, L.Created),2) AS RunningBalance,
	    ...
	    FROM            TransactionHeader AS LH 
	                    ...
	                    RIGHT OUTER JOIN
	                             ...
	                             (SELECT      Journal, JournalSerialNo, GLAccount, JournalTransactionNo, 
	                               ...
	                               FROM       (#preserveSingleQuotes(vwReceivables)#) AS V ) as H
