...
<cfif embed eq "0">
<div id="box" style="overflow: auto; height:100%; min-height:100%; scrollbar-face-color: F4f4f4;">
</cfif>

<table class="navigation_table" width="99%" height="100%" border="0" cellspacing="0" cellpadding="0" align="center">

<cfif header eq "1">
	<tr class="labelmedium line">
	    <TD width="2%"></TD>
		<TD width="90" style="padding-right:10px"><cf_tl id="TransNo"></TD>
	    <TD width="20%" colspan="2"><cf_tl id="Account"></TD>		
		<TD width="20%"><cf_tl id="Details"></TD>
	    <TD width="90"><cf_tl id="Date"></TD>
	    <TD width="40" style="padding-left:3px;padding-right:3px"><cf_tl id="Curr"></TD>
		<td width="9%" align="right"><cf_tl id="Debit"></td>
		<td width="9%" align="right"><cf_tl id="Credit"></td>
	    <td width="9%" align="right"><cf_tl id="Base Debit"></td>
		<td width="9%" align="right"><cf_tl id="Base Credit"></td>	
	</TR>	
<cfelse>
	<tr>
...
<CFOUTPUT>
   ...
   <cfif currrow gte first and currrow lte last>	
	   ...
	   <tr bgcolor="f6f6f6" class="line">
		...
		<td class="labelit" style="padding-right:4px" align="right"><b>#NumberFormat(AmtD,'__,___.__')#</b></td>	
		<td class="labelit" style="padding-right:4px" align="right"><b>#NumberFormat(AmtC,'__,___.__')#</b></td>	
	   </TR>
   ...
   <cfif embed eq "0">
	   ...
	   <TR bgcolor="f1f1f1" class="line">
		...
		<td class="labelit" style="padding-right:4px" align="right"><b>#NumberFormat(AmtDT,'__,___.__')#</b></td>	
		<td class="labelit" style="padding-right:4px" align="right"><b>#NumberFormat(AmtCT,'__,__.__')#</b></td>	
	   </TR>
  ...
  <cfif pages gte "1">	
  	 ...
  	 <tr><td colspan="11" class="line"></td></tr>
	 <tr class="line"><td height="14" colspan="11" class="regular">
			<cfinclude template="Navigation.cfm">
	 </td></tr>
