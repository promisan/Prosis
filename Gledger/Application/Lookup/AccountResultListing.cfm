					  ...
					  <cfif srow-first lt rows and show eq "1">									
						...
						<TD class="navigation_action" style="cursor: pointer;padding-left:4px">
							...
							<cfelse>							
							    ...
							    <cfif TransactionReference neq "">#TransactionReference#<cfelse>#JournalTransactionNo#</cfif></a> 							 
							 </cfif>
...
<cfif url.mode neq "Print">
	...
	<cfoutput>
		<script>		    
			_cf_loadingtexthtml='';
			ColdFusion.navigate('AccountResultPage.cfm?row=#url.row#&page=#url.page#&records=#SearchResult.recordCount#','pagebox')
		</script>
	</cfoutput>
