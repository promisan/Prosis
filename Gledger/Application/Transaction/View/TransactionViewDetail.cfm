...
function PosSettlement() {	
     ...
     ColdFusion.Window.create('wsettle', 'Settlement', '',{x:100,y:100,width:900,height:670,resizable:false,modal:false,center:true})		
...
<!--- ------------------------- --->
<!--- A. show the header lines --->
<!--- ------------------------ --->

<tr>
<td colspan="2" style="padding-top:0px; height:100%;" class="printContent">
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <cfif url.print neq "1">
	  ...
	  <tr class="noprint clsNoPrint"><td colspan="2" align="center" height="20">
