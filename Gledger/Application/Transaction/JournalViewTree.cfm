					  ...
					  <cfloop query="Cat">
						      ...
						      <td class="labelit" style="padding-left:3px">
						        <input type="radio" class="radiol" name="glcategory" 
							     onclick="_cf_loadingtexthtml='';ptoken.navigate('JournalViewTreeShow.cfm?systemfunctionid=#url.systemfunctionid#&mission=#url.mission#&glcategory=#GLCategory#','treeshow')"
