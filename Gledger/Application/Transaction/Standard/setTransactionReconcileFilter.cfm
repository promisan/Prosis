	   ...
	   <tr>	
	    ...
	    <td align="right" valign="top" style="padding-left:10px">	
	   	...
	   	<td style="padding-left:10px">	
			...
			<tr>
				...
				<SELECT name="group" id="group" style="width:100px" onChange="Prosis.busy('yes');_cf_loadingtexthtml='';ptoken.navigate('TransactionDetailReconcileResult.cfm?mode=#url.mode#&ID1='+this.value+'&find='+$('##findvalue').val()+'&tax='+$('##taxvalue').val()+'&ijournal='+$('##tjournal').val()+'&period='+$('##tperiod').val(),'reconcileresult')" class="regularxl">
		...
		<td style="padding-left:10px">
			...
			<table class="formpadding">
				...
				<td style="padding-left:10px">
				<select id="tperiod" name="period" class = "regularxl" style="width:100px" onchange="Prosis.busy('yes');_cf_loadingtexthtml='';ptoken.navigate('TransactionDetailReconcileResult.cfm?mode=#url.mode#&ID1=#URL.ID1#&find='+$('##findvalue').val()+'&tax='+$('##taxvalue').val()+'&ijournal='+$('##tjournal').val()+'&period='+$('##tperiod').val(),'reconcileresult')">
