...
<cf_screentop 
	height="100%" 
	label="#vAdd# Account" 
   	option="Maintain journal accounts" 
	scroll="yes" 
	layout="webapp" 
	jquery="Yes" 
	banner="blue">
...
<cfform name="frmJournalAccount" action="JournalAccountSubmit.cfm?journal=#url.journal#&account=#url.account#">
		...
		<table width="90%" align="center" class="formpadding formspacing">
			...
			<tr class="labelmedium">
				...
				<td>
					...
					<cfinput type="text" name="glaccount"   id="glaccount"      value="#get.glaccount#"           size="5"  readonly class="regularxl" style="text-align: center;" required="Yes" message="#lt_text#">
		    	   	<input type="text" name="gldescription" id="gldescription"  value="#get.AccountDescription#"  size="30" readonly class="regularxl" style="text-align: center;">
