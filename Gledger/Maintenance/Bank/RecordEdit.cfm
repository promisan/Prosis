...
<table width="91%" cellspacing="0" cellpadding="0" align="center" class="formpadding formspacing">
    ...
    <TD><cfinput type="Text" class="regularxl" name="AccountName" value="#get.accountname#" message="Please enter the name of your account" required="Yes" size="30" maxlength="40">
    </TD>
	</TR>
