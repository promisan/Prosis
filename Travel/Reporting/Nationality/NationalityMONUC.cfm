...
<HTML><HEAD><TITLE>Deployed Personnel by Nationality</TITLE></HEAD>
...
WHERE  Organization.dbo.Organization.Mission = 'MONUC'
GROUP BY Ref_Nationality.Name ORDER BY PersonCount DESC
</cfquery>

<cf_dialogStaffing>

<cfset CLIENT.MailSubject  = "Nationality Statistics - MONUC">
<cfset CLIENT.MailAttach   = "../../travel/Reporting/Nationality/NationalityMail.cfm">

<!--- Query returning search results initial approval --->
<table width="100%">
<tr>
  <td><font face="Tahoma" size="4"><b>Nationality Statistics - MONUC</b></font><font face="Tahoma" size="2"><b>, as at <cfoutput>#Dateformat(now(), "#CLIENT.dateformatshow#")#</cfoutput></b></font></td>
  <a href="javascript:window.print()" class="noprint"><img src="../../../Images/print.jpg" alt="Print" width="25" height="21" border="0" onClick=""><font face="Tahoma" size="1"><b>Print</b></font></a>
