<!--- 
	InProcessListing.CFM

	View all MILITARY/CIVPOL personnel that have completed the 'IMIS number generated' 
	but not the 'Milestone: Traveller arrive...' step
	
	Modification History:
	18Apr04 - created by MM
...
--->
<HTML><HEAD><TITLE>Personnel In Process</TITLE></HEAD>
...
function reloadForm(nat,group,page,mission,categ,crit) {
    window.location="InProcessListing.cfm?IDNationality=" + nat + "&IDCategory=" + categ + "&IDSorting=" + group + "&Page=" + page + "&IDMission=" + mission + "&IDCriteria=" + crit;
}
</script>	
...
WHERE  	
	...
	FA.ConditionForView LIKE 'GenerateIMIS' AND	    <!---  and all steps of type 'GenerateIMIS', i.e., Generate IMIS number --->
	D.Status = '0' AND						    	<!---  and document is still pending (otherwise, candidate is not longer in 'In Process' status --->
	DC.PersonNo NOT IN ( SELECT CA.PersonNo FROM DocumentCandidateAction CA, FlowActionView FV
	 		            WHERE  CA.ActionId = FV.ActionId
						AND    CA.DocumentNo = DC.DocumentNo			<!--- 060117 - added line to ensure that nominees that have arrived in the field mission --->
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#002350" frame="all">
  <tr bgcolor="#002350" height="20" valign="middle">
    <td colspan="4"><font face="Tahoma" size="2" color="#FFFFFF"><b>&nbsp;PERSONNEL IN PROCESS</b></font>
	</td>
  </tr>
  <tr bgcolor="#002350" height="15" valign="middle">
    <td colspan="4"><font face="Tahoma" size="1" color="#FFFFFF">
	&nbsp;&nbsp;&nbsp;This view lists all <u>undeployed</u> personnel who have completed the Generate IMIS number step. Personnel still in process after Planned Deployment shown in <i>italics</i>.
	</td>
  </tr>

  <tr bgcolor="#002350" height="15" valign="middle">
    <td colspan="4"><font face="Tahoma" size="1" color="#FFFFFF">
	&nbsp;&nbsp;&nbsp;Note that multi-person requests having a nominee that has not completed the Generate IMIS number step, will reflect the <u>earlier</u> processing status.
	</td>
  </tr>  
