<!--- 
	DeploymentListingParameters.cfm
	
	Parameter setup page for Deployment Listing view

    NOTE: Authorized Mission Nationality temp tables are needed for cases
	when users clicks EXCL radio button when submitting page
	
	Filter by: Mission and Nationality
	
	Calls: DeploymentListing.cfm
	...
	050109 - added code to handle new filters: LastName, FirstName, Arrival, Expected Rotation, Departure, and TOD months
	       - added code to handle new filters: Person Category	
	050726 - added new query field: Gender
	050727 - added new query field: Age
--->

<HTML><HEAD><TITLE>Deployment Listing - View Parameters</TITLE></HEAD>
...
<cfform action="DeploymentListing.cfm" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  <td height="20" class="label">&nbsp;<b>Deployed Personnel - View Parameters</b></td>
  </tr>
