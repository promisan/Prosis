...
<tr><td height="20" align="center"><b>Please wait, while I am preparing your pdf...</b></td></tr>
</table>
</cfoutput>
...
<cfquery name="Get" 
   datasource="AppsSystem" 
      username="#SESSION.login#" 
	   ...
	   WHERE SystemFunctionId  = '#Form.report_file#'
 </cfquery>
...
<form action="#CLIENT.root#/Tools/PDF/show_report.asp" method="POST" name="pdf" id="pdf">
   ...
   <input type="hidden" name="pm_date" value="#FORM.pm_Date#">	 
