<!--- 
	InProcessListingParameters.cfm
	
	Parameter setup page for Personnel In Process Listing view
...
<HTML><HEAD><TITLE>Personnel In Process - View Parameters</TITLE></HEAD>
...
<cfform action="InProcessListing.cfm" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  <td height="20" class="label">&nbsp;<b>Personnel In Process - View Parameters</b></td>
  </tr>
...
<tr><td class="header">&nbsp;&nbsp;2. Click the <b>Incl.</b> radio button to include values in a selection box.</td></tr>
<tr><td class="header">&nbsp;&nbsp;3. For multiple selection, click a list item while holding down the CTRL key.</td></tr>
<tr><td class="header">&nbsp;&nbsp;4. Enter dates in dd/mm/yyyy format. For example, enter 01 Nov 2000 as 01/11/2000.</td></tr>
--->
