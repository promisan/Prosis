...
<!--- 		<input class="regular" type="checkbox" name="ShowSelect" value="All" 
 ...
 --->	</td>
	...
	<td width="2%" class="topN"></td>
	<td width="6%" class="topN">Mission</font></td>
	<td width="3%" class="topN">Nat</font></td>
	<td width="5%" class="topN">Rank</font></td>
	<td width="10%" class="topN">First Name</font></td>	
	<td width="10%" class="topN">Last Name</font></td>
	<td width="5%" class="topN">Cat</font></td>	
	<td width="11%" class="topN">Functional Title</font></td>
	<td width="3%" class="topN">TOD</font></td>
	<td width="6%" class="topN">Arrival</font></td>
	<td width="7%" class="topN">Rotation</font></td>

	<!--- if current user has access to military records --->
	<cfif #AuthorizedForMilitary.Recordcount# GT 0>
		<td width="4%" class="topN">Req#</font></td>	
    	<td width="11%" class="topN">Replacement</font></td>
		<td width="6%" class="topN">PDOA</font></td>
	<cfelse>
		<td width="4%" class="topN">&nbsp;</font></td>
		<td width="11%" class="topN">&nbsp;</font></td>
		<td width="*" class="topN">&nbsp;</font></td>				
	</cfif>	
</tr>
