<!---
	DocumentEditCandidateBatchSubmit.cfm
	
	Process the submit action the candidate batch submit page.
	...
	Called by: DocumentEditCandidateBatch.cfm
	
	Modification History:
	01May04/14June04 - added code to AUTO-PROCESS certain steps as per FlowActionRule table entries (for TRAVEL only)
--->
