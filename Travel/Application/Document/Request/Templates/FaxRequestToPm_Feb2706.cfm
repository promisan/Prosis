...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#111111" class="regularBig2" style="border-collapse: collapse">
  ...
  <tr>
    ...
    <td valign="top">
        ...
        <tr>
          ...
          <td width="*" valign="top" class="regularBig1">LT GENERAL RANDHIR K. MEHTA <br>MILITARY ADVISER</td>
		 </tr>
        <tr>
  ...
  <tr>
	...
	<td width="40%" valign="top" class="regularBig1">&nbsp;<cfoutput>#SearchResult.SeniorOfficial#<br>
													&nbsp;#SearchResult.Title#, #SearchResult.Mission#
													</cfoutput></td>
...
<TABLE width="100%" align="center" style="page-break-after: always;">
	...
	<p align="justify">	
	(a) CURRENTLY ON ACTIVE DUTY WITH A MINIMUM OF SIX YEARS REGULAR MILITARY SERVICE EXPERIENCE;</p>
	<p align="justify">	
	(b) IN THE SAME RANK/FUNCTIONS AS HIS/HER PREDECESSOR.  <b><u>(UNMOS MUST BE BETWEEN THE AGE OF 25 AND 50)</u></b>;</p>
...
<TABLE width="100%" align="center" style="page-break-after: always;">
	...
	<td width="2%">&nbsp;</td>
	<td width="2%">&nbsp;</td>
	<td width="*" colspan="2" class="regularBig2">- STANDARD UNITED NATIONS CURRICULUM VITAE</td>
	</tr>	
	<tr>
	<td width="2%">&nbsp;</td>
	<td width="2%">&nbsp;</td>
	<td width="*" colspan="2" class="regularBig2">- PERSONAL DATA SHEET FOR TRAVEL ITINERARY</td>
	</tr>
	</table>
