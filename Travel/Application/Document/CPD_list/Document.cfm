<!--- 
	Travel/Application/Document/CPD_list/Document.CFM

	Display template document CPD Deployment Tracking
	
	Called by: Dialog.pm_createcpdlist(docno, actdir) which is called by Travel/Application.Template/DocumentEdit_Lines.cfm
	
	Modification History:
	
--->
<HTML><HEAD><TITLE>CPD DEPLOYMENT TRACKING</TITLE></HEAD>

<link href="../../../../<cfoutput>#client.style#</cfoutput>" rel="stylesheet" type="text/css">
<link href="../../../../print.css" rel="stylesheet" type="text/css" media="print">

<cfparam  name="URL.ID1" default="4">
...
<cfquery name="Docs" datasource="AppsTravel" username="#SESSION.login#" password="#SESSION.dbpw#">
	SELECT * FROM FlowActionReport WHERE ActionForm = 'CPD_list'
</cfquery>
...
<cfform action="DocumentSubmit.cfm" method="POST" name="cpdlist">
...
<TABLE width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#002350" frame="all">
	<tr bgcolor="#002350" height="20" valign="middle">
    	<td colspan="4"><font face="Tahoma" size="2" color="#FFFFFF"><b>&nbsp;DOCUMENTS LIST</b></font>
			<cfoutput>
     		<input type="hidden" value="#URL.ID#" name="documentno" size="10" maxlength="10" class="regular">
  	...
  	<table width="100%" border="0" cellspacing="0" cellpadding="1" align="center" rules="rows">		
		...
		<tr><td height="10" bgcolor="#002350"></td></tr>		<!--- Print a dark blue border --->
    </table>	
  ...
  <cfif ParameterExists(URL.ID)>
	  <tr>
   		 <td colspan="2">
	 		<cfinclude template="Templates/CPD_list.cfm">
		 </td>
	  </tr> 
  </cfif>
</TABLE>
