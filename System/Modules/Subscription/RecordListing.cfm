...
<cfelse>
		...
		<TR>
		    <td colspan="13">
				...
				<tr>
					...
					<td align="right">
					<button type="button" class="button3" onClick="purge()" onmouseover="javascript:tooltip('Remove selected reports')" onmouseout="javascript:tooltip('')">
						<img src="#SESSION.root#/Images/trash2.gif" alt="Remove selected reports" border="0" style="bordercolor: f6f6f6; cursor: pointer;" >
					</button>	
					</td>			
				</tr>
				</table>
		...
		<cfoutput>
			...
			<cfelse>
				...
				<td colspan="3" align="center"><font color="FF0000"><cfif Access eq "DIS">Disabled<cfelse>Revoked</cfif></b></td>
			...
			<cfif DateExpiration lt now() and DistributionPeriod neq "Manual">
				...
				<tr>
				 <td align="center" colspan="13" valign="top" class="labelmedium" style="font-weight:200">
				    <font color="red"><b>Attention:</b>&nbsp;&nbsp;the delivery schedule of this report has expired.</font>
				 </td>
				</tr>
