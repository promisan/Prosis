	...
	<table width="100%" align="center">
	  ...
	  <tr>
		...
		<cfelse>
			...
			<TR class="labelmedium navigation_row line" bgcolor="f1f1f1">
			   ...
			   <cfif URL.status eq "0">
				 ...
				 <td style="padding-left:4px;padding-right:24px;padding-top:1px">				   
				   <cf_img icon="delete" onclick="ColdFusion.navigate('GroupPurge.cfm?status=#url.status#&ID=#URL.ID#&ID1=#Account#','groupbox')">				   					
				 </td>			   				  
			   </cfif>	
			   </tr>	
			   </table></td>	   
		...
		<cfif URL.ID1 eq "" and URL.status eq "0">					
			...
			<td colspan="2" height="30" style="padding-left:3px">
			...
			<td colspan="2" align="right"><input name="btn_group" id="btn_group" type="button" onclick="groupsubmit('')" style="width:50" value="Add" class="hide"></td>
