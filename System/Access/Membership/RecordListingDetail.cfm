...
<table width="100%" align="center">
	...
	<table width="100%" class="navigation_table" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		<tr class="labelmedium line" style="height:29px"> 
			...
			<TD width="90"><cf_tl id="Last logon"></TD>
			...
			<TD width="80"><cf_tl id="Membership"></TD>
		...
		<cfloop query="SearchResult">
			...
			<TD><a href="javascript:ShowUser('#URLEncodedFormat(Account)#')"><font color="0080C0">#LastName#, #FirstName#</a></TD>
			<td>#Account#</td>
			...
			<TD>#Dateformat(Joined, "#CLIENT.DateFormatShow#")#</TD>
			<TD  align="center">
			    <cfif URL.Mode eq "Full">
