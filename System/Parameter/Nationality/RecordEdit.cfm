...
<table width="92%" cellspacing="0" cellpadding="0" align="center" class="formpadding">
	...
	<TR>
	 ...
	 <TD class="labelmedium">
	 	<input type="Text" name="Code" id="Code" value="#get.Code#" size="3" maxlength="3" class="regularxl">
    ...
    <TD class="labelmedium">
  	  	<input type="Text" name="name" id="name" value="#get.name#" message="Please enter a description" required="Yes" size="20" maxlength="25" class="regularxl">
    ...
    <TD class="labelmedium">
  	  	<input type="Text" name="isocode" id="isocode" value="#get.IsoCode#" message="Please enter a Iso" required="No" size="3" maxlength="3" class="regularxl">
    ...
    <TD class="labelmedium">
  	  	<input type="Text" name="isocode2" id="isocode2" value="#get.IsoCode2#" message="Please enter a Iso" required="No" size="2" maxlength="2" class="regularxl">
