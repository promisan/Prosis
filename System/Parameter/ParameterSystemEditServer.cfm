<table width="97%" border="0"  class="formpadding" cellspacing="0" cellpadding="0" align="center">
	    ...
	    <TR>
	    <td  colspan="2" width="170"><font face="Calibri" size="3"><b>Web Application Server</b></td>
		</tr>
		<tr><td colspan="2" class="linedotted"></td></tr>
		
	    <TR>
	    <td class="labelmedium" style="padding-left:10" width="170">Virtual Directory to root:</td>
	    <TD width="70%">
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: DefaulteMail --->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Document Web Server URL:</td>
	    <TD>
	  	    <cfoutput query="get">
			<cfinput class="regularxl" type="Text" name="DocumentServer" value="#DocumentServer#" required="Yes" size="50" maxlength="50">
			</cfoutput>
	    </TD>
		</TR>			
		 ...
		 <!--- Field: DefaulteMail --->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Turn on/off Document Storage Server:</td>
	    <TD class="labelmedium">
		 ...
		 <!--- Field: ReplyTo--->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Turn on/off "Reply to" address:</td>
	    <TD class="labelmedium">
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: DefaulteMail --->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Default eMail Address:</td>
	    <TD class="labelmedium">
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: DefaulteMail --->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Log attachments:</td>
	    <TD class="labelmedium">
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: DateFormat --->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Presentation date Format:</td>
	    <TD class="labelmedium">
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: Language --->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Initial Language:</td>
	    <TD>
	    ...
	    <TR>
	    <td colspan="2" class="labelmedium" width="170"><b>SQL Server</b></td>
		</tr>
		
		<tr><td colspan="2" class="linedotted"></td></tr>
	
		<TR>
	    <td class="labelmedium" style="padding-left:10" width="190"><cf_UIToolTip tooltip="db.System and db.Organization">Configuration and Authorization:</cf_UIToolTip></td>
	    <TD>
	  	    <cfoutput query="get">
		...
		<TR>
	    <td class="labelmedium" style="padding-left:10">Transactional Server:</td>
	    <TD>
	  	    <cfoutput query="get">
		...
		<TR>
	    <td class="labelmedium" style="padding-left:40">Server Usage/Upgrade License:</td>
	    <TD>
		...
		<TR>
	    <td class="labelmedium" style="padding-left:40">Server Timezone (GMT +/-):</td>
		...
		<TR>
	    <td class="labelmedium" style="padding-left:10">Default OLAP database:</td>
	    <TD>
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: DateFormat --->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Server date format:</td>
	    <TD>
	  	    <cfoutput query="get">
		...
		<TR>
	    <td class="labelmedium" style="padding-left:10">SQL Collate (searches):</td>
	    <TD>
	  	    <cfoutput query="get">
		...
		<TR>
	    <td colspan="2" class="labelmedium"><b>Mail Server </b><font face="Calibri" size="2">(MS Exchange 2013-6 only)</b></td>
		</tr>
		
		<tr><td colspan="2" class="linedotted"></td></tr>
		
		<TR>
	    <td class="labelmedium" style="padding-left:10" width="170">IP/Name:</td>
	    <TD class="labelmedium">
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: ReplyTo--->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">SMTP sending mode:</td>
	    <TD class="labelmedium">
	  	    <cfoutput query="get">
		 ...
		 <!--- Field: ReplyTo--->
	    <TR>
	    <td class="labelmedium" style="padding-left:10">Mail Content mode:</td>
	    <TD class="labelmedium">
	  	    <cfoutput query="get">
