...
<cf_divscroll>
	...
	<tr><td bgcolor="white" valign="top">
		...
		<tr><td colspan="2" height="400" valign="top">
		
		<cfdiv id="progress#url.id#" style="position:relative;overflow: auto; width:100%; height:370; scrollbar-face-color: F4f4f4;">
			
			<table width="100%" cellspacing="0" cellpadding="0">
			<tr><td colspan="2" align="center" height="360">
		...
		<input type="button" 
		  onclick="showlastaction('#url.id#');ColdFusion.Window.hide('executetask');" 
