...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="left" valign="middle" style="height:45px;padding-left:20px">
		 	...
		 	<select name="AddressType" id="AddressType" class="regularxl" style="height:38px;font-size:28px" required="No">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="96%" align="center" class="formpadding formspacing">
