...
<table width="94%" align="center" cellspacing="0" cellpadding="0">
    ...
    <TD>
	  	   <cfinput type="Text" name="Description" value="#get.description#" message="Please enter a description" required="Yes" size="25" maxlength="40"class="regularxl">
    </TD>
	</TR>
    ...
    <TD>
		<input type="checkbox" class="radiol" name="TriggerTrack" value="1" <cfif get.TriggerTrack eq "1">checked</cfif>>
  	 </TD>
	</TR>
    ...
    <TD>
		<cf_color name="PresentationColor" value="#get.PresentationColor#" mode="limited">
    </TD>
	</TR>
    ...
    <TD>
		<input type="checkbox" class="radiol" name="ShowVacancy" value="1" <cfif get.ShowVacancy eq "1">checked</cfif>>
  	 </TD>
	</TR>
