...
<table width="100%" height="100%">
   ...
   <td colspan="1" height="100%" valign="top" style="padding:10px">
		<cf_securediv id="divListingContainer" style="height:100%" bind="url:#session.root#/Staffing/Reporting/ActionLog/EmployeeCostListingContent.cfm?mission=#url.mission#&SystemFunctionId=#url.systemfunctionid#">        	
	</td>	
