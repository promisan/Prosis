...
function AddPAS(assno,box) {
	...
	ColdFusion.navigate("#SESSION.root#/ProgramREM/Portal/Workplan/PAS/PASCreate.cfm?ts="+new Date().getTime()+"&box="+box+"&Mission=#URL.Mission#&AssignmentNo=" + assno,'mypasdialog');	
}
