...
<cf_treeUnitList
   ...
   <cfif accesslist eq "" or accesslist eq "full">
	   ...
	   <cfloop index="Tbl" list="Mission,orgunitclass" delimiters=",">
	   ...
	   <table height="100%" class="#cl#" id="#tbl#">
	   ...
	   <cfoutput query="SearchResult" group="#tbl#">
		   ...
		   <cfif Class neq "" or tbl eq "Mission">
			 ...
			 <cfif Tbl eq "Mission">	
			    ...
			    <tr>  
			    <td style="height:100%;width:100%;padding-right:20px" rowspan="#span#" class="labellarge">
							
					<table bgcolor="FDFEDE" style="width:100%;height:100%">
					<tr>
					...
					<td valign="top" style="min-width:269px;font-weight:200;width:100%;font-size:31px;padding-top:17px" class="labellarge">		
						#Mission#  			
					</td>
					</tr>
					</table>					
			 ...
			 <cfelse>
			    ...
			    <tr>
				<td rowspan="#span#" class="cellcontent" style="min-width:269px;width:100%;padding-left:30px;font-size:30px;padding-right:20px">				 
				 #OrgUnitClass#
				</td>
