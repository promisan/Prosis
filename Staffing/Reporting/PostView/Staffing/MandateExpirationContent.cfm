...
<table width="98%" height="100%" border="0" bordercolor="silver" cellspacing="0" cellpadding="0" align="center">
	
	<tr><td width="100%" height="100%">			
	
	<cf_listing header  = "PositionExpiration"
	    box             = "actiondetail"
		link            = "#SESSION.root#/Staffing/Reporting/PostView/Staffing/MandateExpirationContent.cfm?mission=#url.mission#&mandate=#url.mandate#&dte=#url.dte#"
	    html            = "No"		
