...
<cfoutput>
	...
	<script language="JavaScript">
		...
		grade = document.getElementById("contractlevel")
		...
		if (effec.value != '') {		
		   ptoken.navigate('#SESSION.root#/staffing/Application/Employee/Contract/ContractEditFormIncrement.cfm?lastcontractid=#url.lastcontractid#&reset=0&eff='+effec.value+'&grade='+grade.value,'increment')	
		}
