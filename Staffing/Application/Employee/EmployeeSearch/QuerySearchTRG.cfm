  ...
  <cfquery name="Result" 
   datasource="AppsPayroll" 
      username="#SESSION.login#" 
       ...
       FROM  PersonEntitlement P
	   WHERE P.SalaryTrigger IN 
	         (SELECT SelectId
        		FROM Employee.dbo.PersonSearchLine
...
<cfelse>
  ...
  <cfquery name = "All" 
   ...
   username="#SESSION.login#" 
   password="#SESSION.dbpw#">
   SELECT DISTINCT PersonNo, SalaryTrigger
    ...
    WHERE  SearchId = '#Value#'
      ...
      <cfquery name="#q#" datasource="AppsQuery" 
         ...
         password="#SESSION.dbpw#">
          ...
          WHERE  tmp#SESSION.acc##tbl#All.SalaryTrigger = '#Select.SelectId#'
	  </cfquery>
      </cfoutput>
