...
<cfquery name="General" 
		...
		AND SearchClass IN ('IndexNo','LastName','FirstName','FullName')
       </cfquery>
...
<cfif Select.RecordCount gt 0>
       ...
       WHERE PersonNo IN (SELECT  P.PersonNo
	                      FROM    userQuery.dbo.tmpadministratorPersonAll P, PersonContract C
