...
<table width="98%" align="center" frame="hsides" border="0" cellspacing="0" cellpadding="0">
	...
	<cfoutput><input type="hidden" name="PersonNo" value="#URL.ID#" class="regular"></cfoutput>
		...
		<table width="94%" border="0" cellspacing="0" cellpadding="0" align="center">
		  ...
		  <tr>
			...
			<cfoutput>
				<cf_tl id="Back" var="1">
		   	   <input type="button" name="cancel" value="#lt_text#" class="button10g" onClick="ptoken.location('EmployeeDocument.cfm?ID=#url.id#')">
