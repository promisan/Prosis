  ...
  <tr>
	...
	<td width="92%" align="center">
		...
		<TR>
	        ...
	        <TD style="padding-left:0px"><textarea style="width:98%;padding:3px;font-size:13px" class="regular" totlength="200"  onkeyup="return ismaxlength(this)" rows="3" name="Remarks">#Document.Remarks#</textarea> </TD>
		</TR>
