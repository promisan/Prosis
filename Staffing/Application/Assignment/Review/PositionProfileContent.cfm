			...
			<tr><td style="height:25;padding-top:4px;padding-bottom:4px">
				...
				<tr>
					...
					<input type="radio" name="ViewMode" id="ViewMode" value="edit" class="radiol"
	     				onclick="ColdFusion.navigate('#session.root#/Staffing/Application/Assignment/Review/PositionProfileContent.cfm?accessmode=edit&id=#url.id#&id1=#url.id1#&languagecode=#url.languagecode#','profilecontent#url.languagecode#')">
						
					</td>
					<td class="labelmedium">Amend</td>
					<td style="padding-left:5px"><input type="radio" name="ViewMode" id="ViewMode" value="view" class="radiol" checked></td>
					<td class="labelmedium"><b>View</td>
				</tr>
				</table>
				...
				<table width="100%">
					...
					<td width="60" style="height:25;padding-top:4px;padding-bottom:4px">		
						...
						<tr>
							...
							<td style="padding-left:5px"><input type="radio" name="ViewMode" id="ViewMode" class="radiol" value="view" 
							     onclick="ColdFusion.navigate('#session.root#/Staffing/Application/Assignment/Review/PositionProfileContent.cfm?accessmode=view&id=#url.id#&id1=#url.id1#&languagecode=#url.languagecode#','profilecontent#url.languagecode#')">
							 </td>
					...
					<td width="100%" align="right" style="padding-right:5px">
						...
						<input type="button" 
					       name="Save" 
						   value="Save" 
						   style="width:140;font-size:13px"
						   class="button10s" 
						   onclick="updateTextArea();ColdFusion.navigate('#session.root#/Staffing/Application/Assignment/Review/PositionProfileSubmit.cfm?id=#url.id#&id1=#url.id1#&languagecode=#url.languagecode#','profilecontent#url.languagecode#','','','POST','profile#url.languagecode#')">
