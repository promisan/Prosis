...
password="#SESSION.dbpw#">
	...
	AND     Mission IN (SELECT Mission FROM Organization.dbo.Ref_Mission WHERE MissionStatus = '0')		
...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0" class="navigation_table formpadding">
	...
	<TR>
	    <td height="26" colspan="3" style="padding-left:5px" class="labelit">Select one or more Entities for your topic</td>
	</TR>
	...
	<cfif ConditionValue is ''>
	   <tr class="labelit regular navigation_row">
	<cfelse>
	   <tr class="highLight navigation_row">
	</cfif>   
