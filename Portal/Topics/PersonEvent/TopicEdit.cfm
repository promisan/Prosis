...
<TR>
    <td height="26" colspan="3" style="padding-left:5px" class="labelmedium">Select one or more Entities for your topic</td>
</TR>
...
<cfelse>
   <tr class="highlight1 navigation_row labelmedium lineditted">
</cfif>   
    ...
    <td width="20%">#Mission#</font></td>
	<TD>#MissionName#</font></TD>
