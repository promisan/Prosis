...
<tr><td height="100%" align="center" style="border-right:1px solid silver">
	...
	<tr class="labelmedium2 line">
		<td style="font-size:17px;min-width:120px;font-weight:bold" rowspan="2"><cf_tl id="Host"><font size="1"><a href="javascript:refresh()"><cf_tl id="Refresh"></a></td>
...
<!---		<input type="button" style="border:1px solid silver;width:100%;height:22px" class="button10g" id="btncurrent" value="Err" onclick="reloadForm('current','ses')">  --->								
	...
	<cfloop query="Summary">	
		...
		<tr class="labelmedium line navigation_row" style="height:21px">
	...
	<tr style="border-top:1px solid silver" class="labelmedium2">
