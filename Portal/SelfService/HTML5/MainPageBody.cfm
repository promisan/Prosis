        ...
        <ul>
			...
			<cfoutput query="MainMenu">
				...
				<cfif access is "GRANTED">
					...
					<cfif vPortalMode eq "login">				
						<cfset vMenuURL = URLEncodedFormat("#SESSION.root#/Portal/SelfService/HTML5/PortalLanding.cfm?webapp=#url.id#&id=#url.id#&#functioncondition#&mission=#vThisMission#&systemFunctionId=#systemFunctionId#&menuClass=#url.menuClass#&mid=#url.mid#&target=#url.target#")>
					<cfelseif vPortalMode eq "default">										
						<cfset vMenuURL = URLEncodedFormat("#SESSION.root#/#Portal.FunctionDirectory#/#Portal.FunctionPath#?webapp=#url.id#&id=#url.id#&#functioncondition#&mission=#vThisMission#&systemFunctionId=#systemFunctionId#&menuClass=#url.menuclass#&target=#url.target#")>
					</cfif>
