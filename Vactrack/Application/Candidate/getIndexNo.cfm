...
<cfif searchResult.recordcount eq "0">
	...
	<CFSET Criteria = "WHERE BirthDate = #DOB# AND Nationality = '#PreserveSingleQuotes(URL.ID4)#'">
	...
	<cf_dialogStaffing>
		...
		<table height="100%" width="99%" align="center">
		  ...
		  <cf_divscroll>
			...
			<TR style="height:22px" class="labelmedium navigation_row line fixlengthlist">
				<TD style="padding-left:8px;padding-top:2px">
				<cf_img icon="select" onclick="applyperson('#IndexNo#','#personNo#','#url.personno#')">
				</TD>
