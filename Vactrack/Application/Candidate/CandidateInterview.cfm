	...
	<tr valign="top" class="line">
		...
		<td colspan="3">
			...
			<textarea rows="3" 
				...
				id = "ReviewMemo"
				class="regular" 
				style="border:0px;border-right:1px solid silver;border-left:1px solid silver;width:100%; font-size:13px;padding: 3px; background-color: ffffff;">#CandidateReview.ReviewMemo#</textarea>
			</cfoutput>
		</td>
	</tr>
