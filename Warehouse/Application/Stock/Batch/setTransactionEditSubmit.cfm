		...
		<cfcase value="quantity">
			...
			<cfif prior.TransactionType eq "2">
						...
						<cfoutput>
							...
							<td width="90%" class="labelit" bgcolor="ffffbf" align="right" style="padding-left:4px; height:18; padding-right:2px;border:1px solid silver">
							...
							<td style="width:30;padding-left:3px;padding-right:4px;padding-top:2px">
								<table width="100%">																	
									<tr>							
									
									<cfif get.transactionQuantity eq "0">		
									<cfelse>
										<td style="padding-left:3px;width:30;padding-right:4px">											
	...
	<cfcase value="reference">	
		   ...
		   <table width="100%">
				<tr class="labelmedium">			    	
					...
					<cf_img icon="edit" onclick="ColdFusion.navigate('#SESSION.root#/warehouse/application/stock/batch/setTransactionEdit.cfm?field=reference&systemfunctionid=#url.systemfunctionid#&transactionid=#url.transactionid#','reference_#url.transactionid#')">																									
					</td>
				</tr>
		   </table>		
