...
<table width="100%" height="100%" align="center">
	...
	<tr>	
		<td colspan="1" height="100%" valign="top">	
			<cf_securediv id="divListingContainer" style="height:100%;" bind="url:../Inquiry/Diversity/ListingDataContainer.cfm?warehouse=#url.warehouse#&location=#url.location#&mission=#url.mission#&SystemFunctionId=#url.SystemFunctionId#">        	
		</td>	
	</tr>	
