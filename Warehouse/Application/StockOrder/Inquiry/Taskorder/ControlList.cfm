...
<cfparam name="url.tasktype" default="internal">
...
<cf_listing
	...
	link           = "#SESSION.root#/Warehouse/Application/StockOrder/Inquiry\TaskOrder\ControlList.cfm?Mission=#URL.Mission#&tasktype=#url.tasktype#"
    html           = "No"		
	tableheight    = "100%"
	tablewidth     = "100%"
