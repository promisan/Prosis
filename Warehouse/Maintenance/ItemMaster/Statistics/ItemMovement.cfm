...
<cfif Movement.recordcount gte "1">	
	...
	<tr class="labelmedium line">
		...
		<td colspan="2" style="min-width:100px;width:100px;border:1px solid silver" align="center">#pe#</td>
		</cfloop>
	</tr>
	...
	<cfloop index="itm" list="#valueList(Transaction.Description)#">
		...
		<tr class="labelmedium">
			...
			<cfloop index="per" list="#PeriodList#">
				...
				<td align="right" style="min-width:50px;border:1px solid silver;background-color:f1f1f1;padding-right:3px">			
				<cfif get.TotalValue neq "">#numberformat(get.TotalValue,",")#</cfif>				
				</td>
