...
<cfform action="ParameterSubmit.cfm?idmenu=#URL.Idmenu#&mission=#URL.mission#"
    ...
    <td>
		...
		<tr>
		<td width="100" style="padding-left:12px"><cf_tl id="Entity">:</td>
			<td>
			 <select name="Mission" id="Mission" class="regularxxl" onchange="reload(this.value)">
	...
	<tr><td>		
		...
		<td colspan="1" height="30" align="center">		
			...
			<tr><td height="100%" style="padding-left:10px">
