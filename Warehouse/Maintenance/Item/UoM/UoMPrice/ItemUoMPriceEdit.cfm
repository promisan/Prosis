...
<cfform action="ItemUoMPriceSubmit.cfm" method="POST" name="frmItemUoMPrice" target="processItemUoMPrice">
	...
	<table width="92%" align="center" class="formpadding formspacing">
		...
		<TR class="labelmedium2">
		    ...
		    <TD><cf_securediv id="divWarehouse" bind="url:Warehouse.cfm?warehouse=#get.warehouse#&mission={mission}"></TD>
		</TR>
	    ...
	    <TD>
	  	     <cfinput type="text" style="text-align:right" name="SalesPrice" 
			      value="#NumberFormat(get.SalesPrice, ".__")#" 
				  size="11" 
				  required="yes" 
	    ...
	    <TD><cf_tl id="Tax">:</TD>
	    <TD>
		   <select name="TaxCode" class="regularxxl">
			    <cfloop query="taxes">
	    ...
	    <TD>
	  	   <input readonly style="background-color:f4f4f4" type="text" name="CalculationMode" value="#get.CalculationMode#" size="20" required="no" message="Please, enter a calculation mode" maxlength="20" class="regularxxl">
	    </TD>
		</TR>
	    ...
	    <TD>
	  	   <input readonly style="background-color:f4f4f4" type="text" name="CalculationClass" value="#get.CalculationClass#" size="20" required="no" message="Please, enter a calculation class" maxlength="10" class="regularxxl">
	    </TD>
		</TR>
	    ...
	    <TD>
	  	   <input readonly style="background-color:f4f4f4" type="text" name="CalculationPointer" value="#get.CalculationPointer#" size="20" required="yes" message="Please, enter a calculation pointer" validate="numeric" maxlength="20" class="regularxxl">
	    </TD>
		</TR>
