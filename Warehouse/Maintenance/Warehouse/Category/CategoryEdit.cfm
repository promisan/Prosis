...
<cfform action="Category/CategorySubmit.cfm?idmenu=#url.idmenu#&id1=#url.id1#&id2=#url.id2#" method="POST" name="warehouse" id="warehouse" target="processWarehouseCategory">
...
<table class="hide">
	<tr><td><iframe name="processWarehouseCategory" id="processWarehouseCategory" frameborder="0"></iframe></td></tr>
</table>
	
<table width="94%" align="center" cellspacing="0" cellpadding="0" class="formspacing formpadding">
    ...
    <TD class="labelmedium" style="height:25px">		
	    ...
	    <table>
		<tr class="labelmedium">
		<td><input type="radio" class="radiol" name="Oversale" id="Oversale" <cfif Get.Oversale eq "1" or url.id2 eq "">checked</cfif> value="1"></td>
		<td style="padding-left:4px">#vYes#</td>
		<td style="padding-left:5px"><input type="radio" class="radiol" name="Oversale" id="Oversale" <cfif Get.Oversale eq "0">checked</cfif> value="0"></td>
		<td style="padding-left:4px">No</td>	
		</tr>		
		</table>
...
<tr><td colspan="2" height="25" align="center">
	<cfoutput>	
		<input type="submit" class="button10g" style="width:120" name="Save" id="Save" value=" #vSave# ">
	</cfoutput>
</td></tr>
