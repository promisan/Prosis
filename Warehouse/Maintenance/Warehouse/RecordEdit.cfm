...
<cfform action="RecordSubmit.cfm?idmenu=#url.idmenu#&id1=#URL.ID1#" 
    style="height:100%;width:100%" method="POST" name="warehouse" id="warehouse">
...
<!--- Entry form --->
	...
	<table width="93%" align="center" class="formpadding">
	   ...
	   <cfquery name="check" 
	    ...
	    <TR>
	    <td style="min-width:210px" class="labelmedium"><cf_tl id="Code">:</td>
		...
		<!--- Field: Description --->
	    <TR>
	    <TD style="min-width:210px" class="labelmedium"><cf_tl id="Name">:</TD>
	    <TD style="width:70%">
		...
		<!--- Field: Location --->
	    <TR>
	    <TD class="labelmedium"><cf_tl id="Default Receipt">:</TD>
	    <TD>
		...
		<TD class="labelmedium" style="width:140px"><cf_tl id="Price Location">:</TD>
	    <TD>
		...
		<tr class="line"><td class="labellarge" colspan="4" style="height:44px;font-size:20px;font-weight:bold">
			<cf_tl id="Address">/<cf_tl id="Contact">
			</td>
	   </tr>
		...
		<cf_calendarscript>
		 ...
		 <!--- Field: Fax--->
	    <TR>
	    <TD class="labelmedium" valign="top" style="padding-left:0px;padding-top:4px"><cf_tl id="Time Zone">:</TD>
	    <TD>
	...
	<tr class="line"><td class="labellarge" colspan="2" style="height:44px;font-size:20px;font-weight:bold">
	...
	<tr> <TD class="labelmedium" style="padding-left:0px"><cf_UIToolTip tooltip="Preferred warehouse for transactional processing"><cf_tl id="Default Warehouse">:</cf_UIToolTip></TD>
		...
		<table>			
		<tr>					
	    <TD><input type="checkbox" class="radiol" name="WarehouseDefault" id="WarehouseDefault" value="1" <cfif "1" eq get.WarehouseDefault>checked</cfif>></TD>	
		<td class="labelmedium" height="20" style="padding-left:15px"><cf_tl id="Operational">:</td>
