...
<cfquery name="CountRec" 
      ...
      password="#SESSION.dbpw#">
		  ...
		  <cfif ParameterExists(Form.Update)>WHERE ActionCode = '#Form.CodeOld#'<cfelse>WHERE 1=0</cfif>	  
    </cfquery>
...
<cfif ParameterExists(Form.Insert)> 
   ...
   <cfelse>
		...
		username="#SESSION.login#" 
		password="#SESSION.dbpw#">
			INSERT INTO Ref_TaskOrderAction
		         (Code,
				 Description,
				 ShipToMode,
				 ListingOrder,
...
<cfif ParameterExists(Form.Delete)> 	
    ...
    <cfelse>
		...
		username="#SESSION.login#" 
		password="#SESSION.dbpw#">
			DELETE FROM Ref_TaskOrderAction
			WHERE Code = '#FORM.CodeOld#'
		</cfquery>
