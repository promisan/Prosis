...
<script>
	function applytext(itm,doc,per,com,act,mde,usr) {		
	   _cf_loadingtexthtml='';	
		ptoken.navigate('#session.root#/Vactrack/Application/CandidateAssessment/AssessmentContent.cfm?itm='+itm+'&documentno='+doc+'&personno='+per+'&competenceid='+com+'&actioncode='+act+'&mode='+mde+'&useraccount='+usr,'box'+itm)	
	}
	...
	<tr><td style="padding:5px">
		...
		<td style="height:95%;width:50%;padding:4px;border:1px solid silver;border-top:0px" valign="top">	
		    ...
		    <cf_securediv style="height:100%" 
			  bind="url:DocumentReviewBase.cfm?itm=#itm#&documentno=#url.documentno#&personno=#getPerson.PersonNo#&actioncode=#url.actioncode#&competenceid=#getPhrases.Topicid#&mode=#url.mode#&useraccount=#session.acc#" 
			 id="box#itm#">				
			 
			<cfelse>
			
			<cf_securediv style="height:100%" id="box#itm#">		
