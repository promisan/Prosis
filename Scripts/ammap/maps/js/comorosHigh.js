 ...
 */
// (c) ammap.com | SVG (in JSON format) map of Comoros - High
// areas: {id:"KM-AN"},{id:"KM-GC"},{id:"KM-MO"}
AmCharts.maps.comorosHigh={
	"svg": {
		"defs": {
			"amcharts:ammap": {
				"projection":"mercator",
