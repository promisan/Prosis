 ...
 */
// (c) ammap.com | SVG (in JSON format) map of Aruba - Low
// areas: {id:"AW"}
AmCharts.maps.arubaLow={
	"svg": {
		"defs": {
			"amcharts:ammap": {
				"projection":"mercator",
				"leftLongitude":"-70.066026",
