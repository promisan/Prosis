 ...
 */
// (c) ammap.com | SVG (in JSON format) map of Cayman Islands - High
// areas: {id:"KY"}
AmCharts.maps.caymanIslandsHigh={
	"svg": {
		"defs": {
			"amcharts:ammap": {
				"projection":"mercator",
