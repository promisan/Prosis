...
<cfform action="ObservationEntrySubmit.cfm" method="POST" enablecab="Yes" name="observation">
	...
	<table width="100%" border="1" bordercolor="silver" cellspacing="0" cellpadding="0" align="left" name="tobservations" id="tobservations">
		...
		<tr><td height="1" colspan="10" bgcolor="e4e4e4"><br><br><br></td></tr>				
	  <tr>
	    <td width="100%" class="def">
	    <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<TR bgcolor="f4f4f4"><TD colspan=10 ><b>OBSERVATION  #currentrow#</b><TD></TR>
		...
		<cfelse>
			...
			<tr><td height="1" colspan="10" bgcolor="D2D2D2"></td></tr>
			 ...
			 <td colspan="10">
				...
				<cfoutput>
				   <iframe src="#SESSION.root#/ProgramREM/Application/Audit/Recommendation/RecommendationEntry.cfm?AuditId=#URL.AuditId#&ObservationId=#Observations.ObservationId#&crow=#currentrow#"
				   name="irecommendation_#currentrow#" id="irecommendation_#currentrow#" width="98%" height="100" marginwidth="0" marginheight="0" hspace="0" vspace="0" align="left" frameborder="0"></iframe>
				</cfoutput>
		...
		<tr><td height="1" colspan="10" bgcolor="e4e4e4"></td></tr>			
			...
			<cfif #URL.ObservationId# eq "" >
				...
				<TR>
				   ...
				   <input type="submit" value=" Add Observation " class="button10p"></td>
