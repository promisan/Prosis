...
<table width="98%" border="1" align="center" bgcolor="f9f9f9" bordercolor="silver">
		...
		<tr>
	       ...
	       <td width="5%"></td>
		   <td class="regular">Report date:</td>
		   <td>&nbsp;
		   
		   <cfif #CLIENT.DateFormatShow# is "US">
		   		   <cfinput type="Text" name="ProgressStatusDate_#Rec#" value="#Dateformat(now(), CLIENT.DateFormatShow)#" message="Please enter a correct date" validate="date" required="Yes" size="10" maxlength="10" style="text-align: center" class="regular">
		   <cfelse>
		   		   <cfinput type="Text" style="text-align: center" name="ProgressStatusDate_#Rec#" value="#Dateformat(now(), CLIENT.DateFormatShow)#" message="Please enter a correct date" validate="eurodate" required="Yes" size="10" maxlength="10" class="regular">
		   </cfif>
		...
		<tr>
		  ...
		  <cfloop query = "Status">
		   ...
		   <cfif Status.Status eq '0'>
			      <input type="radio" name="ProgressStatus_#Rec#" value="#Status.Status#" checked onClick="javascript: revise(this.value,'#Rec#')">&nbsp;#Description#
	   	   <cfelseif URL.Sub eq LastSubPeriod.SubPeriod AND Status.Status eq 2>
		   <cfelse>
				  <input type="radio" name="ProgressStatus_#Rec#" value="#Status.Status#" onClick="javascript: revise(this.value,'#Rec#')">&nbsp;#Description#
	   	   </cfif>
		...
		<tr id="Rev#Rec#" class="hide">
	       ...
	       <td width="5%"></td>
		   <td class="regular">New target:</td>
		   <td>&nbsp;
		   
		    <cfif #CLIENT.DateFormatShow# is "US">
		   		   <cfinput type="Text" style="text-align: center" name="RevisedOutputDate_#Rec#" value="#Dateformat(Output.ActivityOutputDate, CLIENT.DateFormatShow)#" validate="date" required="No" size="10" maxlength="10" class="regular">
		   <cfelse>
		   		   <cfinput type="Text" style="text-align: center" name="RevisedOutputDate_#Rec#" value="#Dateformat(Output.ActivityOutputDate, CLIENT.DateFormatShow)#" validate="eurodate" required="No" size="10" maxlength="10" class="regular">
		   </cfif>
		...
		<tr>
		  ...
		  <td>&nbsp;&nbsp;<textarea cols="70" rows="5" name="ProgressMemo_#Rec#" class="regular"></textarea> &nbsp;
