...
<!--- 
step 1 : generate a table that defines the moment of observation for each period + sub
--->
...
datasource="AppsProgram">
DELETE FROM stPeriod
WHERE SelectionDate > getDate() and Observation = 'In time'
</cfquery>
--->
