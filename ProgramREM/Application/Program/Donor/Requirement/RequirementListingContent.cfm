...
<cfsavecontent variable="myquery">
	...
	FROM
		(
			...
			WHERE     Con.RequirementId = '#url.contributionid#' 			
			AND       ActionStatus = '1'
		) AS Data
		WHERE 	1=1
</cfsavecontent>
...
<cfset fields=ArrayNew(1)>
	...
	<cfset itm = itm+1>
	<cf_tl id="Tranche" var = "1">				
	<cfset fields[itm] = {label   = "#lt_text#",                   		
						  field   = "ContributionLineReference",
						  align     = "left",							
						  search  = "text"}>		
...
<cf_listing
	    ...
	    box            = "linedetail"
		link           = "#SESSION.root#/ProgramREM/Application/Program/Donor/Requirement\RequirementListingContent.cfm?systemfunctionid=#url.systemfunctionid#&contributionid=#url.contributionid#"
	    html           = "No"		
		tableheight    = "100%"
		tablewidth     = "100%"
