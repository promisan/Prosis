...
<cfform method="POST" enablecab="No" name="auditdialog">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	  ...
	  <tr>
		...
		<cfif URL.ID1 eq AuditId>
			...
			<tr bgcolor="ECEEF2">
			   ...
			   <td colspan="2" align="center">
			   	  ...
			   	  <input type="button" 
				       onclick="_cf_loadingtexthtml='';ColdFusion.navigate('AuditSubmit.cfm?action=edit&id=#URL.ID#&box=#URL.box#','#url.box#','','','POST','auditdialog')" 
				       name="update" value="Update" class="button10g" style="font-size:11px;height:19px;width:60px">
		...
		<cfelse>
			...
			<TR class="cellcontent line navigation_row" style="height:25px">
			   <td>&nbsp;</td>	
			   	...
			   	<table cellspacing="0" cellpadding="0">
					<tr>
						<td style="padding-right:5px;">
							<cf_img navigation="Yes" icon="edit" onclick="ColdFusion.navigate('Audit.cfm?action=edit&ID=#URL.ID#&ID1=#Audit.AuditId#&Box=#URL.Box#','#URL.box#');">
						</td>
						<td>
							<cfquery name="Check" 
							datasource="AppsProgram" 
							...
							password="#SESSION.dbpw#">
							   ...
							   <cfif check.recordcount eq "0">
								  <cf_img icon="delete" onclick="ColdFusion.navigate('AuditPurge.cfm?ID=#URL.ID#&ID1=#Audit.AuditId#&Box=#URL.Box#','#URL.box#');">
								<cfelse>
		...
		<cfif URL.ID1 eq ""> <!--- and #URL.ProgramAccess# eq "ALL" --->
			   ...
			   <td colspan="2" align="center">
			    ...
			    <cfoutput>
				   ...
				   <input type="button" 
				   onclick="_cf_loadingtexthtml='';ColdFusion.navigate('AuditSubmit.cfm?action=insert&id=#URL.ID#&box=#URL.box#','#url.box#','','','POST','auditdialog')" 
				   name="update" value="Update" class="button10g" style="font-size:11px;height:19px;width:60px">
				   </cfoutput>
