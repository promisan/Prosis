		...
		password="#SESSION.dbpw#">
			SELECT 	S.*,
					(SELECT ProgramStatus 
					 ...
					 WHERE  Code = '#vThisCode#' 
					 AND    ProgramStatus = S.Code) as Selected
					...
					<cfoutput>
						...
						<cfif Selected eq Code>
							...
							<tr class="navigation_row clsClass_#StatusClass# labelmedium" style="height:15px">
								<td style="#vStatusStyle#;min-width:40px;padding-left:4px" class="row_#vStatusId#">
									<input type="Checkbox" 
