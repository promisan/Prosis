...
<tr><td colspan="2" height="26" align="center"><input type="button" class="button10g" name="Close" onclick="javascript:ColdFusion.Window.hide('rightpanel')" value="Close"></td></tr>
...
<td valign="top">
	<table width="99%" border="0" bordercolor="silver" frame="hsides" align="center" border="0" cellpadding="0" class="formpadding">
		<tr><td><b>Staff:</td>
			<td align="right"><cfoutput><b>#Position.Person#</cfoutput></td>
		</tr>
		<tr><td height="1" colspan="2" bgcolor="C0C0C0"></td></tr>
