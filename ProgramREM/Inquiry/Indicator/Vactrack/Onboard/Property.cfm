...
<tr><td colspan="2" height="7" align="center"><input type="button" class="button10g" name="Close" onclick="javascript:ColdFusion.Window.hide('rightpanel')" value="Close"></td></tr>
