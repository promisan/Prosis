  ...
  <cfquery name="Result" 
   datasource="AppsProgram" 
      username="#SESSION.login#" 
       ...
       FROM  ProgramResource PC, ProgramPeriod P
...
<cfelse>
  ...
  <cfquery name = "All" 
   ...
   username="#SESSION.login#" 
   password="#SESSION.dbpw#">
   SELECT DISTINCT ProgramId, Resource
    ...
    WHERE  SearchId = '#Value#'
      ...
      <cfquery name="#q#" datasource="AppsQuery" 
         ...
         password="#SESSION.dbpw#">
          ...
          WHERE  tmp#SESSION.acc##tbl#All.Resource = '#Select.SelectId#'
	  </cfquery>
      </cfoutput>
...
<!--- IMPORTANT Since program resources are defined on the program component level 
