...
<cfparam name="Form.SubPeriod" type="any" default="">

<cfif #Form.SubPeriod# neq "">
...
<cfquery name="Insert" 
	...
	<cfquery name="Update" 
     ...
     UPDATE ProgramSearchLine
	 SET    SelectDescription = S.Description
	 FROM   ProgramSearchLine INNER JOIN Ref_Subperiod S ON ProgramSearchLine.SelectId =  S.SubPeriod
	 WHERE  ProgramSearchLine.SearchId = '#URL.ID#'
	 AND    ProgramSearchLine.SearchClass = 'SubPeriod'
    </cfquery>
</cfif>
