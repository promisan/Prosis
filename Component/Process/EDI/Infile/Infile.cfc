...
<!--- ISO 8601 --->
		<cfset vInvoiceType = GetWarehouseSeries.DocumentType>
...
<!--- ******* PLEASE NOTE ...... ABOVE the variables that we have to GET from database, this values belong to the FCAM to which credit-note will be applied  ***** --->
		...
		<cfquery name="GetReference"
			...
			INNER JOIN TransactionHeader H ON H.Journal = A.Journal AND H.JournalSerialNo = A.JournalSerialNo
		...
		<cfset vOriginalDate  = #DateFormat(GetSeries.ActionReference3,"YYYY-MM-DD")#>
		<cfset vOriginalUUID  = GetSeries.ActionReference1>
		<cfset vOriginalSerial= GetSeries.ActionReference5>
		<cfset vOriginalNumber= GetSeries.ActionReference2>
		...
		<cfxml variable="XmlDTE">
			...
			<dte:Direccion>#GetInvoice.Address#</dte:Direccion>
				...
				<dte:Pais>GT</dte:Pais>
					...
					<dte:Receptor CorreoReceptor="#GetInvoice.eMailAddress#" IDReceptor="#vNormalizedNIT#" NombreReceptor="#Replace(GetInvoice.CustomerName,"&","")#">
				<cfif GetInvoice.CustomeraddressPostalCode neq "">
					<cfif GetInvoice.CustomerAddress neq "">
						...
						<cfquery name     ="qPostalCodeCheck"
								...
								SELECT        *
								FROM      System.dbo.PostalCode
								WHERE     PostalCode = '#GetInvoice.CustomeraddressPostalCode#'
						</cfquery>
				...
				<cfloop query="GetInvoice">
					<cfif SalesPrice gt 0>
						...
						<dte:UnidadMedida>#vUoM#</dte:UnidadMedida>
							...
							<cfset vSaleAmountWithoutDiscount = SchedulePrice*TransactionQuantity>
							<dte:PrecioUnitario>#trim(numberformat(ABS(SalesPrice),"__._______"))#</dte:PrecioUnitario>
						<dte:Precio>#trim(numberformat((ABS(SalesPrice)*TransactionQuantity),"__._______"))#</dte:Precio>
			...
			<dte:GranTotal>#vInvoiceTotalAmount#</dte:GranTotal>
				...
				<cfif vInvoiceType eq "NCRE">
						<dte:Complementos>
						<dte:Complemento IDComplemento="ComplementoReferenciaNota"  NombreComplemento="ReferenciasNota" URIComplemento="http://www.sat.gob.gt/face2/ComplementoReferenciaNota/0.1.0">
								<cno:ReferenciasNota
								xmlns:cno="http://www.sat.gob.gt/face2/ComplementoReferenciaNota/0.1.0" Version="0.1" FechaEmisionDocumentoOrigen="#vOriginalDate#" NumeroAutorizacionDocumentoOrigen="#vOriginalUUID#" NumeroDocumentoOrigen="#vOriginalNumber#" SerieDocumentoOrigen="#vOriginalSerial#" />
					</dte:Complemento>
					</dte:Complementos>
				</cfif>
				</dte:DatosEmision>
...
<!--- 							<cfif Category eq "DSC">
			...
			<cfset stError = httpResponse.statusCode>
