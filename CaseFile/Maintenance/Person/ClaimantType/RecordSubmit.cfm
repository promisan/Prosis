...
<cfif ParameterExists(Form.Delete)> 
    ...
    <cfif #CountRec.recordCount# gt 0 >
	 <cfoutput>
   	 <cf_tl id="Type is in use. Operation aborted." class="Message" var = "1">
     <script language="JavaScript">
