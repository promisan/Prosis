...
<cf_tl id = "Add Claim Category" var = "1">
...
<table width="95%" align="center" cellspacing="0" cellpadding="0" class="formpadding">
    ...
    <TD class="labelit">
		<cfinput type="Text" name="Code" id="Code" value="" message="Please enter a code" required="Yes" size="20" maxlength="20"
		class="regularxl">
	</TD>
	</TR>
	...
	<tr>	
		...
		<input class="button10g" type="button" style="width:90" name="Cancel" value=" <cfoutput>#lt_text#</cfoutput>" onClick="window.close()">
		<cf_tl id = "Submit" var = "1">
		<input class="button10g" type="submit" style="width:90" name="Insert" value=" <cfoutput>#lt_text#</cfoutput> ">
		</td>
