...
<cf_tl id = "Edit Claim Class" var = "1">
...
<!--- Field: code --->
    ...
    <TD class="labelit">
		<cf_tl id = "Please enter a description" var ="1">
  	  	<input type="Text" name="Description" id="Description" value="#get.Description#" message="#lt_text#" required="Yes" size="50" maxlength="50" class="regularxl">
	...
	<tr>	
		...
		<input class="button10g" type="button" style="width:80" name="Cancel" value=" #lt_text# " onClick="window.close()">
		<cf_tl id = "Delete" var ="1">		
		<input class="button10g" type="submit" style="width:80" name="Delete" value=" #lt_text# " onclick="return ask()">
		<cf_tl id = "Update" var ="1">
		<input class="button10g" type="submit" style="width:80" name="Update" value=" #lt_text# ">
		</td>
	</tr>
