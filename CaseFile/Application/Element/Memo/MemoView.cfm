		...
		<td colspan="4">
			<cf_textarea name="Memo"
					    height="200"					 				 		 
					 	...
					 	init = "No"
					 	toolbar="basic"					 
						onKeyUp="ColdFusion.navigate('#SESSION.root#/tools/input/text/memolength.cfm?field=Memo&size=2000','memcount','','','POST','memoform')"></cf_textarea>
		</td>
		</tr>
		...
		<tr><td colspan="5" align="center">
		    ...
		    <cfoutput>		
				<input type = "button" 
				  ...
				  style   = "width:140px" 
				  class   = "button10s" 
				  onclick = "updateTextArea();ColdFusion.navigate('../Memo/MemoView.cfm?tabno=#url.tabno#&elementid=#url.elementId#&memoid=#memoid#&mission=#url.mission#','contentbox#url.tabno#','','','POST','memoform')">
			</cfoutput>
		</td></tr>
		<tr><td height="3"></td></tr>
