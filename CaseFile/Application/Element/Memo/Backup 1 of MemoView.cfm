	...
	<cfoutput query="Memo">
		...
		<cfif url.memoid eq memoid and form.Memo eq "" and SESSION.acc eq OfficerUserId>
			...
			<tr bgcolor="ffffff">
				...
				<cftextarea name="Memo" class="regular" style="width:95%;height:95%;word-wrap: break-word; word-break: break-all;"
				onKeyUp="_cf_loadingtexthtml='';ColdFusion.navigate('#SESSION.root#/tools/input/text/memolength.cfm?field=Memo&size=2000','mcount','','','POST','memoform')">#ElementMemo#</cftextarea>
				</td>
			</tr>
			<!--- attachments --->
