...
<cfsavecontent variable="myquery">
	...
	<cfoutput>	  	
		...
		SELECT   IndexNo,
				 ...
				 P.DateEffective as DateProcessed,  <!--- has to come from the action PersonAppointmentAction --->
				 R.AppointmentType,
...
<cf_listing
	    header              = "action"
	    box                 = "actionlisting"
		link                = "#SESSION.root#/DHEnterprise/Employee/Appointment/AppointmentContentL1.cfm?indexno=#url.indexno#&systemfunctionid=#url.systemfunctionid#"
	    html                = "No"		
		tableheight         = "100%"
		tablewidth          = "100%"
		calendar            = "9" 
