...
<tr><td height="20">
	...
	<tr><td colspan="2" align="center" height="10">
	   ...
	   onclick="ColdFusion.navigate('#SESSION.root#/tools/selectlookup/Role/Result.cfm?page=1&close=#url.close#&box=#box#&link=#link#&des1=#des1#&filter1=#filter1#&filter1value=#filter1value#&filter2=#filter2#&filter2value=#filter2value#','resultunit#box#','','','POST','selectrole')"
	   class="button10g">
