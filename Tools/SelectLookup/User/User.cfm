...
<tr><td valign="top" style="height:100%;padding-top:8px">

<cf_divscroll>

	<cfoutput>
	
		<table width="93%" height="100%" align="center" align="center">
		...
		<form name="selectuser#box#" method="post" style="height:100%">
		
			<table width="100%" height="100%" class="formspacing" align="center"
				...
				<cfelse>
				    <TD class="labelmedium"><cf_tl id="Name or Group">:</TD>
				</cfif>	
				...
				<TD><SELECT name="Crit0_Operator" id="Crit0_Operator" class="regularxl">#SelectOptions#</SELECT>
				...
				<INPUT type="hidden" name="Crit4_FieldName" id="Crit4_FieldName" value="AccountMission">			
				<INPUT type="hidden" name="Crit4_FieldType" id="Crit4_FieldType" value="CHAR">
				<TR>
				<TD class="labelmedium"><cf_tl id="Entity">:</TD>
				<TD><SELECT name="Crit4_Operator" id="Crit4_Operator" class="regularxl">#SelectOptions#</SELECT>
					   ...
					   <cfif getAdministrator("*") eq "1">
							...
							<TD style="padding-left:5px">
							    <table class="formpadding" cellspacing="0" cellpadding="0">
									<tr>
										<td><input class="radiol" type="radio" name="Status" id="Status" value="0" checked></td>
										<td style="padding-left:4px" class="labelmedium"><cf_tl id="Active"></td>
										<td style="padding-left:7px"><input class="radiol" type="radio" name="Status" id="Status" value="1"></td>
