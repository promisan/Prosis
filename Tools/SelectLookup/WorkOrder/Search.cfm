...
<tr><td>
	...
	<cfoutput>
		...
		<TD>
			...
			<input type="input" name="Crit1_Value" id="Crit1_Value" class="regularxl"  
		...
		<TD>
			...
			<input type="input" name="Crit2_Value" id="Crit2_Value" class="regularxl"  
		     onkeyup="if (window.event.keyCode == '13') { document.getElementById('search').click() }"> 
...
<tr>
	<td colspan="2" align="center"><cfdiv id="resultworkorder#box#"></td>
</tr>
