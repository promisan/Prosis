...
<tr bgcolor="f1f1f1">
	...
	<td align="right">
	 ...
	 <cfif URL.Page gt "1">	 
	       <input type="button" name="Prior" id="Prior" value="<<" class="button3" onClick="ptoken.navigate('#nav#&page=#url.page-1#','searchresult','','','POST','searchselect')">
	   </cfif>
	  <cfif URL.Page lt "#Pages#">
	       <input type="button" name="Next" id="Next" value=">>" class="button3" onClick="ptoken.navigate('#nav#&page=#url.page+1#','searchresult','','','POST','searchselect')">
	   </cfif>
	   &nbsp;
	</td>	
</tr>						
