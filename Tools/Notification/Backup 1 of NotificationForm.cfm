	...
	<table cellspacing="0" width="92%" align="center" class="formpadding formspacing">
		...
		<tr>	
			<td colspan="2" style="padding-left:10px;padding-top:3px">
				<cftextarea required="yes" style="padding:3px;font-size:13px;width:99%; height:70px; border-radius:5px;border:1px solid silver" name="message" message="#tlmessage# must be defined">#Event.Description#</cftextarea>
			</td>
		</tr>
