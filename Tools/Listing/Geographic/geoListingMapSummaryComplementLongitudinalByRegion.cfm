...
<cfoutput>
    <h3 style="padding-bottom:10px;">
        <img src="#session.root#/images/Excel.png" style="cursor:pointer;" width="35" height="35" onclick="Prosis.exportToExcel('detailGeoCompLongitudinalByRegionContent#url.viewId#Detail');" title="#lblExportToExcel#">
