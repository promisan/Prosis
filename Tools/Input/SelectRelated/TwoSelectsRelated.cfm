...
<CFOUTPUT><SELECT NAME="#Attributes.Name1#" class="regularxl" onChange="#FunctionName#" SIZE="#Attributes.Size1#" <CFIF Attributes.Width1 is not "">STYLE="width:#Attributes.Width1#"</CFIF>></CFOUTPUT>
...
<CFOUTPUT><SELECT NAME="#Attributes.Name2#" class="regularxl" SIZE="#Attributes.Size2#" <CFIF Attributes.onChange is not "">onChange="#Attributes.OnChange#"</CFIF> <CFIF Attributes.Width2 is not "">STYLE="width:#Attributes.Width2#"</CFIF>></CFOUTPUT>
	<!--- SPECIAL FIRST ITEM, IF REQUESTED --->
...
<!--- need to fire #functionname# once to populate second menu with unique values (grouped) --->
<cfoutput>
