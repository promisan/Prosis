...
<cfif entityaccess eq "EDIT">
 ...
 <tr bgcolor="ffffff" height="50">
    <td height="29" width="90" style="padding-left:10px" class="labelmedium"><cf_tl id="Decision">:</td>
    <td>	   
    <table id="processblock" cellspacing="0" cellpadding="0"><tr>
   ...
   <cfif entityaccess eq "EDIT">
		  ...
		  <cfquery name="Methods" 
			...
			<td id="d2n" class="labelmedium" style="padding:0 10px 0 0;cursor: pointer;" onclick="document.getElementById('r2n').click()">
			    ...
			    <img src="#SESSION.root#/Images/Deny.png" width="24" height="24" 
				   alt="No, denied" border="0" 
				   align="absmiddle">
		   ...
		   <td id="d2y" class="labelmedium" style="padding:0 4px 0 0;cursor: pointer;" 
			   onclick="document.getElementById('r2y').click()">
			   
			    <img src="#SESSION.root#/Images/Approve.png" width="24" height="24"
				   alt="Yes, agreed" border="0" 
				   align="absmiddle">
				   <cfif URL.Process neq ""><font color="C0C0C0"></cfif>
