...
<cfquery name="Actor" 
	...
	<table style="width:100%" class="navigation_table">
		...
		<tr><td id="processactor"></td></tr>
		
		<tr class="line labelmedium2 fixlengthlist">
		   <td><cf_tl id="Officer"></td>
		   <td><cf_tl id="Decision"></td>
		   <td><cf_tl id="Memo"></td>
		...
		<cfoutput query="Actor">
		    ...
		    <cfif (useraccount eq session.acc and (process.recordcount eq "0" or process.decision eq "")) or getAdministrator("#Object.Mission#") eq "1"> 
				...
				<tr class="line labelmedium2 fixlengthlist" style="height:30px">
				   ...
				   <td style="border-left:1px solid silver;border-right:1px solid silver;width:80%">
				   ...
				   <input type="button" value="#lt_text#" style="width:100%"
				    onclick="Prosis.busy('yes');ptoken.navigate('#session.root#/Tools/EntityAction/Details/Actor/ActorViewSubmit.cfm?objectid=#objectid#&actionCode=#actionCode#&useraccount=#useraccount#','processactor','','','POST','processaction')">
					</td>
				</tr>
				
			<cfelse>
			
				<tr class="line labelmedium2 navigation_row fixlengthlist" style="height:30px">
		...
		<tr><td colspan="4" id="resultuser">
		<cfinclude template="setResult.cfm">
