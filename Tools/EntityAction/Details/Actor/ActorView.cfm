...
<tr><td id="processactor">
	...
	<cfif check.recordcount eq "0" or check.decision eq "">  
		    ...
		    <cfif (useraccount eq session.acc and (process.recordcount eq "0" or process.decision eq ""))
				...
				<tr class="line labelmedium2 fixlengthlist" style="height:30px;background-color:white">
				   ...
				   <td valign="top" style="padding-top:1px">
					   ...
					   <td style="padding-left:8px"><input type="radio" class="radiol" name="#userAccount#_Decision" value="3" <cfif Process.decision eq "3">checked</cfif>></td><td style="padding-top:3px;padding-left:4px"><cf_tl id="Approve"></td>
					   <td style="padding-left:8px"><input type="radio" class="radiol" name="#userAccount#_Decision" value="9" <cfif Process.decision eq "9">checked</cfif>></td><td style="padding-top:3px;padding-left:4px"><cf_tl id="Reject"></td>
					   </tr>
					   </table>
			...
			<cfelse>
				...
				<tr class="line labelmedium2 navigation_row fixlengthlist" style="height:30px;background-color:white">
				   ...
				   <td style="border-left:1px solid silver;padding-left:5px">
				    <cfif Process.decision eq "0">--<cfelseif Process.decision eq "">--<cfelseif Process.decision eq "3"><cf_tl id="Approve"><cfelse><cf_tl id="Reject"></cfif>		  
				   </td>   
