 		...
 		<tr>
			<td valign="top" style="padding-top:8px">						
				<table width="96%"  cellspacing="0" cellpadding="0" align="center">
					<tr>
						<td height="20" align="center" class="header" colspan="2"><h3><cf_tl id="Requested by"></h3></td>
					</tr>
					<tr>
                                    <td height="20" align="right" width="49%"><b><cf_tl id="Name">: </b></td><td height="20" align="left" width="49%">&nbsp; #Last.OfficerFirstName# #Last.OfficerLastName#</td>
					</tr>
					<tr>
						<td height="20" align="right"><b><cf_tl id="On">: </b></td><td height="20" align="left">&nbsp; #dateformat(now(),"#CLIENT.DateFormatShow#")# #timeformat(now(),"HH:MM")# <td>
					</tr>
					<!---
					<tr>
					...
					--->
					<tr>
						<td height="20" align="right"><b><cf_tl id="eMail">: </b> </td><td height="20" align="left">&nbsp; <a href = "mailto:#Mail.eMailAddress#">#Mail.eMailAddress#</a></td>
					</tr>
					<tr>
						<td height="20" align="right"><b><cf_tl id="Report problems to">: </b></td><td height="20" align="left">&nbsp; <a href = "mailto:#Parameter.SystemContactEMail#">#Parameter.SystemContactEMail#</a></td>
					</tr>	
					
					<tr><td height="20"></td></tr>
					
					<tr>
                                    <td height="20" colspan="2" align="center"><h3><cf_tl id="Action details"></h3></td>
					</tr>
					<tr>
						<td class="line" colspan="2"></td>
					</tr>							
					<tr>
						<td height="20" align="right"><b><cf_tl id="Subject">: </b></td><td height="20" align="left">&nbsp; #qObject.EntityDescription#</td>
					</tr>					
					<tr>
						<td height="20" align="right"><b><cf_tl id="Action">: </b></td><td height="20" align="left">&nbsp; #Action.ActionDescription#</td>
					</tr>
					<tr>
						<td height="20" align="right"><b><cf_tl id="Reference">: </b></td><td height="20" align="left">&nbsp; #qObject.ObjectReference#</td>
					</tr>
					<tr>
						<td height="20" align="right"><b><cf_tl id="Memo">: </b></td><td height="20" align="left">&nbsp; #qObject.ObjectReference2#</td>
					</tr>
