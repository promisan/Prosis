			...
			<cfelseif now() lt SessionAction.SessionPlanStart and sessionAction.SessionPlanStart neq "">			
				...
				<cfelse>
					...
					<cfoutput>
						...
						<div class="subtitle">It will be available starting #timeformat(SessionAction.SessionPlanStart,"HH:MM")# (#dateformat(SessionAction.SessionPlanStart,client.dateformatshow)#) 
						local time: #dateformat(now,client.dateformatshow)# #timeformat(now(),"HH:MM")#</div>	
					</cfoutput>  
