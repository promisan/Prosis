...
<table width="100%" align="center">
	...
	<cfoutput>
	<tr><td style="height:50px" class="labellarge">

	<table width="100%">

	<tr>
	
		<td style="font-size:24px;font-weight:200" class="labellarge">
			<cfif URL.IDFunction eq "">
				<cf_tl id="Candidate Roster Profile">	
			<cfelse>
		    ...
		    <tr>
			  ...
			  <td align="right" valign="top" class="noprint">
					...
					<td align="right" style="padding-left:6px;padding-right:4px" class="labelit">
						<cfoutput>
						<a href="##" onclick="window.open('#session.root#/Roster/PHP/PHPEntry/PHPProfile.cfm?scope=backoffice&owner=#attributes.owner#&personno=#getCandidates.PersonNo#&applicantno=#URL.ID#');">
						   Edit
						</a>
						</cfoutput>
					</td>				
	...
	<cfoutput query="getCandidates">
		...
		<cfset url.PersonNo  = PersonNo>		
			...
			<cfif attributes.hideLanguage eq "No">			
				...
				<tr>
				<td align="center" bgcolor="f1f1f1" class="labelmedium" style="font-weight:200;height:20px;-moz-border-radius: 2px;border-radius: 2px;padding:4px;border:1px solid silver"><cf_tl id="Languages"></td>
				</tr>			
			...
			<cfif attributes.hideEducation eq "No">			
				<tr><td height="4"></td></tr>
				<tr>
				<td bgcolor="f1f1f1" align="center" style="font-weight:200;height:20px;-moz-border-radius: 2px;border-radius: 2px;padding:4px;border:1px solid silver" class="labelmedium"><cf_tl id="Academic Classifications"></td>	
				</tr>
				<tr>
			...
			<tr><td height="4" </td></tr>
			<tr>
			<td bgcolor="f1f1f1" align="center" class="labelmedium" style="font-weight:200;height:20px;-moz-border-radius: 2px;padding:4px;border:1px solid silver"><cf_tl id="Work Experience"></td>
			</tr>
			<tr>
			<td valign="top" style="padding:4px;border-right:0px dotted silver">				
