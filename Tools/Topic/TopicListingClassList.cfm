...
<table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">			
   ...
   <tr #stylescroll#>
	  ...
	  <td><A href="javascript:ColdFusion.navigate('#SESSION.root#/tools/topic/TopicListingClassList.cfm?action=delete&Topic=#URL.Topic#&ItemNo=#ItemNo#','l#url.Topic#_item')">
