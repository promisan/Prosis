...
<cfquery name="Items" 
   ...
   <tr class="labelit navigation_row">
	  ...
	  <td><A href="javascript:ColdFusion.navigate('#SESSION.root#/Tools/Topic/Materials/ItemClass.cfm?action=delete&Topic=#URL.Topic#&ItemNo=#ItemNo#','l#url.Topic#_item')">
