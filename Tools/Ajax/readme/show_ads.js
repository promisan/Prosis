...
;c("cust_gender",a.google_cust_gender);c("cust_interests",a.google_cust_interests);c("cust_id",a.google_cust_id);c("cust_job",a.google_cust_job);c("cust_u_url",a.google_cust_u_url);if(z(a,d)&&d.body){var u=d.body.scrollHeight;var v=d.body.clientHeight;if(v&&u){f("cc",Math.round(v*100/u))}}D(a,g);G(a,d,a.google_ad_url);F(a)}
