...
<tr class="line labelmedium">
	<td height="18" class="labelit" style="padding-left:6px">
	  Record <b>#First#</b> to <b><cfif Last gt Counted>#Counted#<cfelse>#Last#</cfif></b> of <b>#Counted# records</b>  
	</td>
	
	<td align="right" bgcolor="ffffff" style="padding-right:4px">	
	...
	<cfif FindNoCase("?",link) eq 0>
	 ...
	 <cfif URL.Page gt "1">
		 ...
		 onClick="ptoken.navigate('#link##connector#page=#URL.page-1#','contentbox2')">
	 </cfif>
