...
<table width="100%" align="center" border="0"  class="formpadding" cellspacing="0" cellpadding="0">

<tr class="xxhide"><td colspan="4" align="center" id="processpreview"></td></tr>
...
<tr class="line"><td class="labelmedium" style="height:30px;font-size:23px;padding-left:5px">
   ...
   <cfloop index="grp" list="1,2" delimiters=","> 
	   ...
	   <td width="20"></td>
        ...
        <td>
		    <select <cfif disable eq "1">disabled</cfif> class="regularxl" style="font-size:15px" name="Grouping#Grp#" id="Grouping#Grp#" onChange="javascript:fieldadd(this.value,'Group#Grp#','#url.id#','#url.table#')">
...
<tr><td colspan="2">
	...
	<table width="98%" align="right" border="0" cellspacing="0" class="formpadding">
