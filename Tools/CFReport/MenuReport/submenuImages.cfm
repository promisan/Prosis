 ...
 <cfoutput>
  ...
  <cfelseif FunctionIcon eq "Flash">	
         <img src="#SESSION.root#/Images/report_icon.png"  width="30" height="30" align="absmiddle" alt="Open report"> 	 
  <cfelseif FunctionIcon eq "PDF">	
         <img src="#SESSION.root#/Images/report_icon.png" width="30" height="30" align="absmiddle" alt="Open report" alt="" border="0"> 
