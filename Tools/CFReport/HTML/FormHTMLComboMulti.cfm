...
<form name="multiform" id="multiform" style="height:98%">
	...
	<tr><td colspan="2" bgcolor="white" valign="top" style="padding:1px;height:60%">
		...
		<tr>
		 <td colspan="2" height="40%" valign="top" style="padding-left:10px;padding-right:20px">
		  ...
		  <cf_divscroll id="multiselectbox" style="position:absolute;overflow: auto; width:98%; height:144px; scrollbar-face-color: F4f4f4;">		
	...
	<span class="hide" id="selectedvalues"></span> 
