			...
			<tr>
				...
				<cfif criteriaNameParent neq "">
					...
					<cfselect name="#CriteriaName#_#Name1#"
						...
						multiple="#mul#"	
						class="regularXXL"
						style="height:#ht#;padding-right:5px;padding-right:5px;max-width:200px"
						size="#s#" 						
						bind="cfc:service.Input.InputDropdown.DropdownSelect('#LookupDataSource#','#LookupTable#','#Name1#','#Sort1#','#Display1#','parent',{#CriteriaNameParent#},'','','','','#def#','#cond#','#Name1#','#codeInDisplay1#','#mul#')"/>				
				...
				<cfelse>	
					...
					<cfselect name="#CriteriaName#_#Name1#"
						bindOnLoad="yes"										
						multiple="#mul#"	
						style="height:#ht#;padding-right:5px;max-width:200px"
						class="regularXXL"
						size="#s#" 						
						bind="cfc:service.Input.InputDropdown.DropdownSelect('#LookupDataSource#','#LookupTable#','#Name1#','#Sort1#','#Display1#','','','','','','','#def#','#cond#','#Name1#','#codeInDisplay1#','#mul#')"/>				
			...
			<cfif Fields.recordcount eq "2">				
				...
				<cfif criteriaNameParent neq "">
				  	...
				  	<cfselect name="#CriteriaName#"
						...
						multiple="#mul#"	
						class="regularXXL"
						style="height:#ht#;padding-right:10px;max-width:250px"
						size="#s#" 						
				...
				<cfelse>
				 ...
				 <cfif criteriaNameParent neq "">
					 ...
					 <cfselect name="#CriteriaName#_#Name2#"
						 ...
						 multiple="#mul#"
						 class="regularXXL"
						 style="height:#ht#;padding-right:10px;;max-width:200px"
						 size="#s#" 
