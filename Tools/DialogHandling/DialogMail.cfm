...
function email(to,subj,att,filter,src,srcid) {
	window.open(root + "/Tools/Mail/Mail.cfm?ID=" + to +"&ID1=" + subj + "&source=" + src + "&sourceid=" + srcid, "_blank", "width=1000, height=735, status=yes, toolbar=no, scrollbars=no, resizable=no");
}
