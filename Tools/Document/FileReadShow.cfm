	...
	<cfoutput>
		...
		<cfif url.ser eq "">
				...
				<cfif find(".dat", "#att.fileName#")>
					...
					<cfcontent type="text/plain" file="#SESSION.rootDocumentPath#\CFRStage\User\#SESSION.acc#\#att.fileName#">
				</cfif>
...
<!--- secure copy --->
			...
			<cfif not FileExists("#SESSION.rootDocumentPath#\CFRStage\User\#SESSION.acc#\#att.fileName#")>
...
open within the context of the application --->
					...
					<cfset session.sd = "#SESSION.rootdocumentPath#\CFRStage\User\#SESSION.acc#\">
