...
<cfoutput>
	...
	<Table cellspacing="0" cellpadding="0" height="18">
		<tr>
		<td>
		<input type="text" name="PersonDescription" id="PersonDescription" class="regularxl" size="30" maxlength="80" value="#Person.IndexNo# #Person.FirstName# #Person.LastName# <cfif Person.gender neq "">(#Person.Gender#)</cfif>" readonly>
