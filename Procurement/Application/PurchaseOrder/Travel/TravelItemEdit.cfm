...
<table width="99%" align="center" height="100%" class="formpadding">
...
<TR>
	...
	<cfif itm eq "T03"><cf_tl id="Accommodation">:</cfif>
	<cfif itm eq "T04"><cf_tl id="Meals Provided">:</cfif>
	</td>
	...
	<td style="padding-left:4px;padding-right:6px">
		...
		password="#SESSION.dbpw#">
			...
			AND  IndicatorCode = '#itm#'
		</cfquery>
		
		<input type="checkbox" class="radiol" name="IndicatorCode_#itm#" id="IndicatorCode_#itm#" value="1" <cfif Pointer.recordcount eq "1">checked</cfif>>
		
	</td>
	
	</cfloop>
	
	<td class="labelmedium" style="padding-left:5px"><cf_tl id="Perc">:</td>
	...
	<tr>
		<td class="labelmedium"><cf_tl id="Rate in"> <cfif Line.Currency neq "">#Line.Currency#<cfelse>#APPLICATION.BaseCurrency#</cfif>:</td>
		<td colspan="3">
