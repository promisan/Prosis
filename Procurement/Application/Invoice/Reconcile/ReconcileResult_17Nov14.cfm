...
<cfif URL.mode eq "save">
		...
		<cfoutput>
			...
			<script language="JavaScript">
				ColdFusion.navigate('ReconcileViewInvoice.cfm?mission=#url.mission#&vendorcode2=#form.vendor2#&vendorcode3=#form.vendor3#','invoicebox')
				ColdFusion.navigate('ReconcileViewLedger.cfm?mission=#url.mission#&vendorcode=#form.vendor#&vendorcode3=#form.vendor3#','ledgerbox')
			</script>
