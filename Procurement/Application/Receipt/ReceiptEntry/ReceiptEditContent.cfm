...
<table width="99%" border="0" align="center">
	...
	<td colspan="2" style="padding-left:20px;height:25;font-size:20px;font-weight:200" class="labellarge"><cf_tl id="Shipment and Receipt Details"> #Receipt.ReceiptNo#</td>
