...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0" class="formpadding">
    ...
    <TR height="18" class="linedotted labelmedium">
	   <td width="20"></td>
	   <td width="10%">Code</td>
			...
			<TR bgcolor="ffffcf">
			   ...
			   <td>
			     ...
			     <td>
				     ...
				     <input type="Checkbox"
				       name="Tracking"
                       id="Tracking" class="radiol" 
				       value="1"
					   <cfif Tracking eq "1">checked</cfif>>
		...
		<cfelse>
			...
			<TR class="labelmedium">
			   ...
			   <td align="center" style="padding-top:3px;">
				 ...
				 <cf_img icon="open" onclick="ColdFusion.navigate('RecordListingDetail.cfm?ID2=#code#','listing')">
			  </td>
			   
			   <td height="17">&nbsp;
			   <A href="javascript:ColdFusion.navigate('RecordListingDetail.cfm?ID2=#code#','listing')">
			   #code#</a></td>
			   <td>
			   <A href="javascript:ColdFusion.navigate('RecordListingDetail.cfm?ID2=#code#','listing')">
			   #description#
			   ...
			   <td align="right">#dateformat(created,CLIENT.DateFormatShow)#</td>
				...
				<td align="center" width="20" style="padding-top:3px;">
				  <cfif check.recordcount eq "0">
				      <cf_img icon="delete" onclick="ColdFusion.navigate('RecordListingPurge.cfm?Code=#code#);">
				  </cfif>	   
