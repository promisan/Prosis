...
<table width="97%" align="center" class="formpadding">
    ...
    <TR>
    <td width="180" class="labelmedium2">Prefix/LastNo:</b></td>
    <TD>
	...
	<TR>
    <td class="labelmedium2">Vendor Tree:</b></td>
    <TD>
	...
	<TR>
    <td valign="top" style="padding-top:6px" class="labelmedium2"><cf_UIToolTip tooltip="Payroll uploads will inherit this class">Payroll Obligation:</cf_UIToolTip></b></td>
    <TD>
		<table cellspacing="0" cellpadding="0" class="formpadding">
		
		<tr>
		<td class="labelmedium2">Order class:</td>
		<td>
		<cfquery name="Class" 
		datasource="AppsPurchase" 
		username="#SESSION.login#" 
		...
		<tr>
	    <td class="labelmedium2"><cf_UIToolTip tooltip="Payroll uploads will inherit this class">Order Type:</cf_UIToolTip></b></td>
	    <TD>
	...
	<TR>
    <td class="labelmedium2">Label Custom Entry Field 1:</b></td>
    <TD>
		...
		<td>&nbsp;&nbsp;</td>
	    <td class="labelmedium2">Label Custom Entry Field 2:</b></td>
		<td>&nbsp;&nbsp;</td>
	    <TD>
	...
	<TR>
    <td class="labelmedium2" >Label Custom Entry Field 3:</b></td>
    <TD>
	<table cellspacing="0" cellpadding="0" style="formspacing">
		<tr><td>
		...
		<td>&nbsp;&nbsp;</td>
	    <td class="labelmedium2">Label Custom Entry Field 4:</b></td>
		<td>&nbsp;&nbsp;</td>
	    <TD>
	...
	<TR>
    <td class="labelmedium2">Default Custom field</td>
    <TD>
		<table>
		<tr>
		...
		<td class="labelmedium2" style="padding-left:4px"><input class="radiol" type="radio" name="PurchaseCustomField" id="PurchaseCustomField" <cfif PurchaseCustomField eq "1">checked</cfif> value="1"></td><td class="labelmedium2" style="padding-left:4px">1</td>
		<td class="labelmedium2" style="padding-left:4px"><input class="radiol" type="radio" name="PurchaseCustomField" id="PurchaseCustomField" <cfif PurchaseCustomField eq "2">checked</cfif> value="2"></td><td class="labelmedium2" style="padding-left:4px">2</td>
		<td class="labelmedium2" style="padding-left:4px"><input class="radiol" type="radio" name="PurchaseCustomField" id="PurchaseCustomField" <cfif PurchaseCustomField eq "3">checked</cfif> value="3"></td><td class="labelmedium2" style="padding-left:4px">3</td>
		<td class="labelmedium2" style="padding-left:4px"><input class="radiol" type="radio" name="PurchaseCustomField" id="PurchaseCustomField" <cfif PurchaseCustomField eq "4">checked</cfif> value="4"></td><td class="labelmedium2" style="padding-left:4px">4</td>
		</tr>
		</table>
	</td>
    </tr>
	...
	<TR>
    <td class="labelmedium2" style="cursor: pointer;"><cf_UIToolTip  tooltip="Once enabled, you must nabled one or more Order classes">Express Purchase:</cf_UIToolTip></b></td>
	...
	<td class="labelmedium2" style="padding-left:4px">Allow (define for Procurement Class)</td>
	</td>
	...
	<td style="padding-left:4px" class="labelmedium2">Disabled</td>
	</tr></table>
    </td>
    </tr>
	
	<TR>
    <td class="labelmedium2" style="cursor: pointer;"><cf_UIToolTip  tooltip="Enforce purchase orders to be created that match the job vendor assignment">Purchase from single job:</cf_UIToolTip></b></td>
    <TD class="labelmedium2">
		...
		<td class="labelmedium2">Enforce</td>		
	...
	<TR>
    <td class="labelmedium2" style="cursor: pointer;"><cf_UIToolTip  tooltip="TaxExemption will automatically deduct tax amounts from the purchase, invoice and receipt amounts recorded">Tax Exemption:</cf_UIToolTip></b></td>
    <TD class="labelmedium2">
	<table class="formspacing">
		<tr>
	...
	<TR>
    <td class="labelmedium2" valign="top" style="padding-top:3px">Add a Quoted Line <br>to a existing Purchase Order:</b></td>
    <TD style="padding:6px;border-left:1px solid gray">
	
		<table border="0" cellspacing="0" cellpadding="0">
		<tr>
		<td class="labelmedium2" style="padding-left:4px">Scope:</td>
		...
		<td class="labelmedium2" style="padding-left:4px">Issued by Same Buyer</td>
		...
		<td class="labelmedium2" style="padding-left:4px">Issued by Any Buyer</td>
	    </tr>	
		<TR>
		<td class="labelmedium2" style="padding-left:4px">Status:</td>
	    <TD style="padding-left:4px">
			...
			<td class="labelmedium2" style="padding-left:4px" style="padding-right:5px">Open and closed Purchase Orders</td>
		<td style="padding-left:4px">
		   ...
		   <td class="labelmedium2" style="padding-left:4px">Open Purchase Order only</td>
	   
	    </tr>
		<TR>
		<td class="labelmedium2" style="padding-left:4px">Funding:</td>
	    <TD style="padding-left:4px">
			...
			<td class="labelmedium2" style="padding-left:4px">Same Object of Expenditure</td>
		<td style="padding-left:4px">
		   ...
		   <td class="labelmedium2" style="padding-left:4px; padding-right:5px">Any Object Of Expenditure</td>   
	    </tr>	
		
		<TR>
		<td class="labelmedium2" style="padding-left:4px">Period:</td>
	    <TD style="padding-left:4px">
			...
			<td class="labelmedium2" style="padding-left:4px">Any Period</td>
		<td style="padding-left:4px">
		   ...
		   <td class="labelmedium2" style="padding-left:4px">Same Period</td>
	...
	<TR>
    <td class="labelmedium2">Edit Purchase Lines after Issuance:</b></td>
    <TD class="labelmedium2">
		<table class="formspacing">
		<tr>
	...
	<TR>
    <td class="labelmedium2" style="cursor: pointer;"><cf_UIToolTip tooltip="Enable option to initiate a procurement execution request">Purchase Execution Request:</cf_UIToolTip></b></td>
    <TD class="labelmedium2">
		<table class="formspacing">
		<tr>
	...
	<TR>
    <td class="labelmedium2">Purchase Class Tracking:</b></td>
    <TD>
		<table class="formspacing">
		<tr>
	...
	<TR>
    <td class="labelmedium2">Issued Purchase:</b></td>
    <TD class="labelmedium2">
    ...
    <TR>
    <td class="labelmedium2">Sub-Directory Attachment:</b></td>
    <TD>
   ...
   <TR>
    <td class="labelmedium2">Default Print Template:</b></td>
    <TD>
	...
	<TR>
    <td class="labelmedium2" height="30">Inherit Purchase Address:</b></td>
    <TD>
		...
		<tr>
			...
			<td>
				...
				<tr><td class="labelmedium2">&nbsp;#itm#:</td></tr>
				<tr><td>
