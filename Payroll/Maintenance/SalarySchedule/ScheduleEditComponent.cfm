...
<cf_divscroll style="height:100%">
	...
	<table width="96%" align="center" class="navigation_table">
			...
			<tr class="fixrow2 line">
			    <td height="30" colspan="9" style="height:40px;padding-left:10px;font-size:20px;" class="labellarge">#TriggerGroup#</td>
			</tr>
							
				<cfoutput>
				
				<TR bgcolor="#IIf(CurrentRow Mod 2, DE('FFFFFF'), DE('efefef'))#" class="line navigation_row labelmedium2">
				...
				<cfset com = "#replace(com,'-','','ALL')#">
				    ...
				    <td width="10%" align="center">
						...
						<cfif Check.recordcount eq "0">
							...
							<input type="checkbox" class="radiol" name="select_#Com#" value="#Code#" <cfif ComponentName neq "">checked</cfif> onclick="toggleme('#com#',this.checked)">
						<cfelse>
