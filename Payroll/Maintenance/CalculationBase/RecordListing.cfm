...
<script language = "JavaScript">
	...
	function recordadd(grp) {
	      window.open("RecordEdit.cfm?idmenu=#url.idmenu#", "Add", "left=80, top=80, width=990, height=860, toolbar=no, status=yes, scrollbars=yes, resizable=yes");
	}
	
	function recordedit(id1) {
	      window.open("RecordEdit.cfm?idmenu=#url.idmenu#&ID1=" + id1, "Edit", "left=80, top=80, width=990, height=860, toolbar=no, status=yes, scrollbars=yes, resizable=yes");
	}
