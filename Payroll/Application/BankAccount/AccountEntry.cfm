	...
	<table width="100%" align="center">
	  ...
	  <tr>
	    <td style="padding-top:6px;padding-left:22px" width="100%">
		    ...
		    <TR style="height:40px" class="line labelmedium2">
		    <TD style="width:180px"><cf_tl id="Effective date">:</TD>
		    <TD>	
				<table><tr><td>
		    ...
		    <TD style="height:32px"><cf_tl id="Destination">:</TD>
		    <TD>	
			...
			<TR class="labelmedium2">
		    <TD style="height:32px"><cf_tl id="Account type">:</TD>
			<TD>
			...
			<TR class="labelmedium2">
		    <TD><cf_tl id="Account currency">:</TD>
			...
			<TR class="labelmedium2">
		        <td valign="top" style="padding-top:6px;"><cf_tl id="Pay through">:</td>
