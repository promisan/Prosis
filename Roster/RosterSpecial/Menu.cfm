	...
	<cfloop query="OwnerList">
		...
		<cfif SESSION.isAdministrator eq "Yes" or findNoCase(own,SESSION.isOwnerAdministrator)>
			...
			password="#SESSION.dbpw#">
					...
					AND     E.Operational = 1 
					ORDER BY ExerciseClass, DateEffective
			</cfquery>
		...
		<cfelse>
			...
			password="#SESSION.dbpw#">
			 ...
			 <tr class="line"><td colspan="6" style="padding-left:2px;height:48px;font-size:25px" class="labelmedium">
		  ...
		  <cfif Check.recordcount gte "1">
			   ...
			   <cfoutput query="Check">
					...
					<cfset functionMemo      = "#ExerciseClass#<br>#dateformat(dateeffective,client.dateformatshow)#">
