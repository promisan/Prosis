		   ...
		   <cf_space spaces="24" class="labelmedium" align="center" label="Total">	
			...
			<cfloop query="Resource">
				   ...
				   <cfif Resource.PostGradeBudget eq "Subtotal">
				   		<cf_space spaces="22"  class="labelmedium" align="center" label="#Left(Resource.Code,8)#">
				         <cfset subT = subT & "-#Resource.CurrentRow#-">
				   <cfelse>
				   <cf_space spaces="14" class="labelmedium" align="center" label="#Left(Resource.PostGradeBudget,6)#">
				   </cfif>
				   </td>
			</cfloop>
