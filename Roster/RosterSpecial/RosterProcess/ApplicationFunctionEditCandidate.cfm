...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr bgcolor="EaEaEa" style="border:1px solid silver">
   	...
   	<td valign="top" id="picturebox" style="width:5%;padding:5px">  
    ...
    <td valign="top" style="padding-left:6px;padding-top:5px">
	   ...
	   <cfoutput query="Get" maxrows=1>
	    ...
	    <table width="100%" border="0">
	     ...
	     <TR>
		     ...
		     <td colspan="4" class="labellarge" style="height:34px">
		...
		<TR>
	    <td style="padding-left:5px" width="150" class="labelit"><cfoutput>#client.IndexNoName#</cfoutput>:</td>
		...
		<td width="150" class="labelit"><cf_tl id="Email">:</td>
	    <TD colspan="1" class="labelmedium" style="height:22px;padding-right:10px;">
		...
		<cfif Organization.Mission is not ''>#Organization.Mission#<cfelse>#Organization.OrgUnitName#</cfif></TD>
		   ...
		   <cfquery name="Status" 
	        ...
	        <td class="labelmedium" style="height:22px" bgcolor="#Status.InterfaceColor#">
