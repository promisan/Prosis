...
<cfelse>
	...
	<tr><td colspan="1" class="labelit">Search Archive:</td></tr>
			...
			<cfif FunctionalTitle neq "">
				...
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<td align="right" class="labelit" style="padding-right:15px">
						<a href="javascript:showdocument('#documentno#')"><font color="0080C0">#DocumentNo#</font></a></td>
					</tr>
				</table>
			<cfelse>
				<td class="labelit"><a href="ResultView.cfm?mode=#url.mode#&docno=#url.docno#&ID=#SearchId#" target="#tg#">#Dateformat(created,CLIENT.DateFormatShow)# #Dateformat(created,"HH:MM")# <font color="0080FF">#Description#</a></td>
			</cfif>			
			</tr>
