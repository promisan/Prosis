...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <TD>
    	<input type="input" name="FunctionDescription" id="FunctionDescription" value="#Get.FunctionDescription#" required="yes" class="regularxl" >
			<!-----
		<cf_LanguageInput
	...
	<table cellspacing="0" cellpadding="0" class="formspacing">
		...
		<TR>
	    <TD class="labelsmall"><cf_tl id="Prefix">:</TD>
	    <TD class="labelsmall" style="padding-left:3px"><cf_tl id="Keyword">:</TD>
	    <TD class="labelsmall" style="padding-left:3px"><cf_tl id="Suffix">:</TD>
	    </tr>
			
		<TR>
		    <TD><cfinput type="Text" name="FunctionPrefix" tooltip="Functional Title Prefix like : <b>Chief" value="#Get.FunctionPrefix#" required="No" size="20" maxlength="20" class="regularxl"></TD>
			<TD style="padding-left:3px"><cfinput type="Text" name="FunctionKeyword" tooltip="Functional Title Prefix like : <b>Finance" value="#Get.FunctionKeyword#" required="No" size="30" maxlength="60" class="regularxl"></TD>
			<TD style="padding-left:3px"><cfinput type="Text" name="FunctionSuffix" tooltip="Functional Title Prefix like : <b>Officer" value="#Get.FunctionSuffix#" required="No" size="15" maxlength="20" class="regularxl"></TD>
		</TR>
    ...
    <TD>
		...
		<cfselect name="FunctionClassification" class="regularxl" required="Yes" tooltip="Functional Title Classification Code">
    ...
    <TD>
	   ...
	   <td style="cursor:pointer; height:14; width:15; border: 0px solid silver;">
	       ...
	       <cfinput type="text" 
				 ...
				 tooltip="doubleclick to remove entry" 
				 class="regularxl" 
				 size="50" 
...
<tr><td class="linedotted" height="1"></td></tr>	
	...
	<cfif Access eq "EDIT" or Access eq "ALL">  
		<input class="button10g" style="width:136;height:27" type="button" name="UpdateC" value="Save" onclick="ColdFusion.navigate('RecordSubmit.cfm?action=save','result','','','POST','formentry')">
	</cfif>
