...
<input type="button" class="button10g" id="Send" name="Send" value="Broadcast Edition" style="height:28;width:210" onclick="doSend('#url.submissionedition#','#url.actionid#')">	
	...
	<script language="JavaScript1.1">	  
	   ...
	   function reloadDetail(){
	   		ColdFusion.navigate('#SESSION.root#/Roster/Maintenance/RosterEdition/Recipient/RecipientViewDetail.cfm?submissionedition=#url.submissionedition#', 'recipients');
	   }
	   ...
	   ColdFusion.Window.show('BroadcastWindow'); 			
