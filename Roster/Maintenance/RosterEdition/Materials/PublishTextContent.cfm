...
<cfoutput>
	...
	<cfquery name="Language"
			...
			WHERE    L.LanguageCode IN ( SELECT LanguageCode
...
<!--- Getting Previous Texts for easy maintenance by Armin 5/18/2021 ---->
	<cfloop query="Language">
		...
		<cfquery name="getPrevious"
				...
				AND      SubmissionEdition = '#Edition.SubmissionEdition#'
				AND      ActionStatus = '9'
		...
		<cfloop query="language">
			...
			<cfelse>
				<cfif url.scope eq "backoffice">
					   <td style="cursor:pointer" align="center" onclick="parent.ptoken.open('#client.root#/Roster/Maintenance/RosterEdition/Materials/PublishText.cfm?actionid=#url.actionid#&submissionedition=#url.submissionedition#&languagecode=#languagecode#','languagebox')">
							<img height="50" width="66" src="#client.root#/images/flag/#code#.gif" >
					   </td>
				<cfelse>
					   <td style="cursor:pointer"
							align="center"
								onclick="ptoken.navigate('#client.root#/Roster/Maintenance/RosterEdition/Materials/PublishText.cfm?actionid=#url.actionid#&scope=#url.scope#&submissionedition=#url.submissionedition#&languagecode=#languagecode#','dialog')">
							<img height="50" width="66" src="#client.root#/images/flag/#code#.gif" >
					   </td>
				</cfif>
			</cfif>
